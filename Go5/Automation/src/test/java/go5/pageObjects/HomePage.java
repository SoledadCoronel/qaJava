...
import org.testng.Reporter;
    ...
    public class HomePage {
    	...
    	private String goToAdministrarPersonasCss=".igoadminwhite:first-child";
    	private String goToTitulosCss=".igotitleswhite:first-child";
    	...
    	private String goToAdmistrarStoreCs=".igoadminwhite:last-child";
    	private String goToTiendaCss=".igotitleswhite:last-child";
