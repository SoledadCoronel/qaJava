...
public class testSinVerifLogUsernameId extends AllTestsRegUniqUsernameId {
...
private WebDriver driver;
	...
	public void test_SinVerif_LogUsernameId_WithoutGenderFNPass_row161() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
	...
	public void test_SinVerif_LogUsernameId_WithoutGenderPass_row162() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_WithoutFNPass_row163() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_WithoutPass_row164() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_WithoutGenderFN_row165() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_WithoutGender_row166() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_WithoutFN_row167() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogUsernameId_row168() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), false, "Id", "-- Sin segundo campo de verificación", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
