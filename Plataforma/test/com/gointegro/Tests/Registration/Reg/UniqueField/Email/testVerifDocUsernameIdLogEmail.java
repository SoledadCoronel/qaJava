...
public class testVerifDocUsernameIdLogEmail extends AllTestsRegUniqEmail {
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderFNPass_row57() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderPass_row58() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutFNPass_row59() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutPass_row60() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderFN_row61() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGender_row62() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutFN_row63() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_row64() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
