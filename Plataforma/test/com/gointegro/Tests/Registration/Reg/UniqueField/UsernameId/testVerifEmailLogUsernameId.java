...
public class testVerifEmailLogUsernameId extends AllTestsRegUniqUsernameId {
	...
	public void test_VerifEmail_LogEmail_WithoutGenderFNPass_row113() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
	...
	public void test_VerifEmail_LogEmail_WithoutGenderPass_row114() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_WithoutFNPass_row115() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_WithoutPass_row116() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_WithoutGenderFN_row117() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_WithoutGender_row118() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_WithoutFN_row119() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmail_LogEmail_row120() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldUsernameIdAccountId(), true, "Email", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
