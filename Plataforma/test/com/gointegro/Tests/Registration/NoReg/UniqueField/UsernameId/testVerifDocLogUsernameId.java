...
public class testVerifDocLogUsernameId extends AllTestsNoRegUniqUsernameId {
	...
	public void test_VerifDoc_LogUsernameId_WithoutGenderFNPass_row41() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		...
		assertEquals(signup.getUsernameId(), workbook.getId());
	...
	public void test_VerifDoc_LogUsernameId_WithoutGenderPass_row42() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_WithoutFNPass_row43() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_WithoutPass_row44() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_WithoutGenderFN_row45() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_WithoutGender_row46() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_WithoutFN_row47() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogUsernameId_row48() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
