...
public class testVerifDocEmailLogEmail extends AllTestsNoRegUniqUsernameId {
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderFNPass_row17() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderPass_row18() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutFNPass_row19() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutPass_row20() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderFN_row21() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutGender_row22() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutFN_row23() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_row24() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
