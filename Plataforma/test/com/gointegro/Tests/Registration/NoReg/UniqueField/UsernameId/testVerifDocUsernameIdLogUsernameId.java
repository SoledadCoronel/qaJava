...
public class testVerifDocUsernameIdLogUsernameId extends AllTestsNoRegUniqUsernameId {
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderFNPass_row65() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderPass_row66() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutFNPass_row67() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutPass_row68() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderFN_row69() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGender_row70() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutFN_row71() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_row72() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
