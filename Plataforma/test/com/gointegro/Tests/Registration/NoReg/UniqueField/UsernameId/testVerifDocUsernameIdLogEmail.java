...
public class testVerifDocUsernameIdLogEmail extends AllTestsNoRegUniqUsernameId {
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderFNPass_row57() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderPass_row58() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutFNPass_row59() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutPass_row60() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGenderFN_row61() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutGender_row62() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_WithoutFN_row63() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogEmail_row64() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
