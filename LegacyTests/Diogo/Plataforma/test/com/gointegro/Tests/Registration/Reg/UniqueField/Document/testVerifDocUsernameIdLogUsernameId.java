...
public class testVerifDocUsernameIdLogUsernameId extends AllTestsRegUniqDocument {
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderFNPass_row65() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderPass_row66() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutFNPass_row67() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutPass_row68() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGenderFN_row69() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutGender_row70() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_WithoutFN_row71() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocUsernameId_LogUsernameId_row72() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Id", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
