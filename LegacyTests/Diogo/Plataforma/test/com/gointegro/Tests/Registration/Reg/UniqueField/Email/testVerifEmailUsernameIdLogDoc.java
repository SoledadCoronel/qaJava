...
public class testVerifEmailUsernameIdLogDoc extends AllTestsRegUniqEmail {
...
private WebDriver driver;
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutGenderFNPass_row73() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutGenderPass_row74() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutFNPass_row75() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutPass_row76() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutGenderFN_row77() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutGender_row78() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_WithoutFN_row79() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogDoc_row80() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Email", "Id", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
