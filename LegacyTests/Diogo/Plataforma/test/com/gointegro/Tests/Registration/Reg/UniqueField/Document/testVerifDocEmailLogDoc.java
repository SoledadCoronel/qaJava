...
public class testVerifDocEmailLogDoc extends AllTestsRegUniqDocument {
	...
	public void test_VerifDocEmail_LogDoc_WithoutGenderFNPass_row1() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
	...
	public void test_VerifDocEmail_LogDoc_WithoutGenderPass_row2() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_WithoutFNPass_row3() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_WithoutPass_row4() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_WithoutGenderFN_row5() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_WithoutGender_row6() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_WithoutFN_row7() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogDoc_row8() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Documento", "Email", "Documento");
		WaitTool.waitForJQueryProcessing(driver, 10);
