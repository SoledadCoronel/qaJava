...
public class testVerifDocEmailLogEmail extends AllTestsRegUniqEmail {
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderFNPass_row17() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderPass_row18() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutFNPass_row19() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutPass_row20() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutGenderFN_row21() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutGender_row22() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_WithoutFN_row23() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogEmail_row24() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
