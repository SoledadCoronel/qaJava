...
public class testVerifDocLogEmail extends AllTestsNoRegUniqUsernameId {
	...
	public void test_VerifDoc_LogEmail_WithoutGenderFNPass_row33() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
	...
	public void test_VerifDoc_LogEmail_WithoutGenderPass_row34() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_WithoutFNPass_row35() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_WithoutPass_row36() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_WithoutGenderFN_row37() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_WithoutGender_row38() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_WithoutFN_row39() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDoc_LogEmail_row40() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), true, "Documento", "-- Sin segundo campo de verificación", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
