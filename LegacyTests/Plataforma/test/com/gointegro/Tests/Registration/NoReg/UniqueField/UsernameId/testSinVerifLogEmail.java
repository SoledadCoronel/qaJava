...
public class testSinVerifLogEmail extends AllTestsNoRegUniqUsernameId {
	...
	public void test_SinVerif_LogEmail_WithoutGenderFNPass_row153() {
		...
		common.configPlatform(false, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
	...
	public void test_SinVerif_LogEmail_WithoutGenderPass_row154() {
		...
		common.configPlatform(true, false, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_WithoutFNPass_row155() {
		...
		common.configPlatform(false, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_WithoutPass_row156() {
		...
		common.configPlatform(true, true, false, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_WithoutGenderFN_row157() {
		...
		common.configPlatform(false, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_WithoutGender_row158() {
		...
		common.configPlatform(true, false, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_WithoutFN_row159() {
		...
		common.configPlatform(false, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_SinVerif_LogEmail_row160() {
		...
		common.configPlatform(true, true, true, ConfigElementsRegistration.getPlatformIdUniqueFieldUsernameId(), false, "", "", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
