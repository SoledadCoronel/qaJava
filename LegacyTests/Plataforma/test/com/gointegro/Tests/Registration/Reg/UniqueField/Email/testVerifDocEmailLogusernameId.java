...
public class testVerifDocEmailLogusernameId extends AllTestsRegUniqEmail {
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutGenderFNPass_row25() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutGenderPass_row26() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutFNPass_row27() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutPass_row28() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutGenderFN_row29() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutGender_row30() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_WithoutFN_row31() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifDocEmail_LogUsernameId_row32() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldEmailAccountId(), true, "Documento", "Email", "Id");
		WaitTool.waitForJQueryProcessing(driver, 10);
