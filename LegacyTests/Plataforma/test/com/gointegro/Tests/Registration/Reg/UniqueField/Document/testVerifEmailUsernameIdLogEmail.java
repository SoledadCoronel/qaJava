...
public class testVerifEmailUsernameIdLogEmail extends AllTestsRegUniqDocument {
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutGenderFNPass_row81() {
		...
		common.configAccount(false, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutGenderPass_row82() {
		...
		common.configAccount(true, false, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutFNPass_row83() {
		...
		common.configAccount(false, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutPass_row84() {
		...
		common.configAccount(true, true, false, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutGenderFN_row85() {
		...
		common.configAccount(false, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutGender_row86() {
		...
		common.configAccount(true, false, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_WithoutFN_row87() {
		...
		common.configAccount(false, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
	...
	public void test_VerifEmailUsernameId_LogEmail_row88() {
		...
		common.configAccount(true, true, true, ConfigElementsRegistration.getUniqueFieldDocumentAccountId(), true, "Email", "Id", "Email");
		WaitTool.waitForJQueryProcessing(driver, 10);
