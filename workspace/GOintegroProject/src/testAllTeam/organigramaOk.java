...
public class organigramaOk {
	  ...
	  @Test
	  public void organigrama() throws Exception {
		// Inicia el test
	    ...
	    driver.findElement(By.cssSelector("a[title=\"Organigrama\"] > span.app-name")).click();
	    Thread.sleep(2000);
	    ...
	    String expectedText = "Management";
	    
	    // Se valida que el texto es el esperado
	    if(capturedText.equals(expectedText)) {
	    	System.out.println("organigramaOk  [OK]");
	    }
	    else {
	    	System.out.println("organigramaOk  [FAIL]");
	    }	    
	  }
