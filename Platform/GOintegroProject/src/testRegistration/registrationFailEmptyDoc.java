...
public class RegistrationFailEmptyDoc {
	  ...
	  public void testRegFailEmptyDoc() throws Exception {
	    ...
	    driver.findElement(By.id("document")).sendKeys("");
	    ...
	    Thread.sleep(1000);
	    String capturedText = new String(driver.findElement(By.id("documentError")).getText());

	    //Se setea el texto de validaci—n esperado
	    String expectedText = "El documento no puede estar vac’o.";
	    
	    // Se valida que el texto es el esperado
	    if(capturedText.equals(expectedText)) {
	    	System.out.println("registrationFailEmptyDoc  [OK]");
	    }
	    else {
	    	System.out.println("registrationFailEmptyDoc  [FAIL]");
	    }
	  }
