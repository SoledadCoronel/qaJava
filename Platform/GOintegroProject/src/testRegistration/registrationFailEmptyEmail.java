...
public class RegistrationFailEmptyEmail {
	  ...
	  @Test
	  public void testRegFailEmptyEmail() throws Exception {
		// Iniciando el test
	    ...
	    String expectedText = "El correo electr—nico no puede estar vac’o.";
	    
	    // Se valida que el texto es el esperado
	    if(capturedText.equals(expectedText)) {
	    	System.out.println("registrationFailEmptyEmail  [OK]");
	    }
	    else {
	    	System.out.println("registrationFailEmptyEmail  [FAIL]");
	    }
	  }
