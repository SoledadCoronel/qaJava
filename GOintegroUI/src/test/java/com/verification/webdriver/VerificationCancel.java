...
public class VerificationCancel {
    ...
    @Test
    // Iniciando el test
    public void testVerificationCancel() throws Exception {
        ...
        if(capturedText.equals(expectedText)) {
                System.out.println("testVerificationCancel  [OK]");
        }
        else {
            System.out.println("testVerificationCancel  [FAIL]");
        }
        // Se presiona Cancelar
        driver.findElement(By.id("verificationCancel")).click();
    }
