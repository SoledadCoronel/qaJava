...
public class CstOperations {
    ...
    @Test
    public void testCstOperations() throws Exception {
        // Inicia el test
        ...
        if(capturedText.equals(expectedText)) {
            System.out.println("testCstOperations  [OK]");
        }
        else {
            System.out.println("testCstOperations  [FAIL]");
        }
    }
