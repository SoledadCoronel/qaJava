...
public class PartnerShipBO {
    ...
    @Test
    public void testPartnerShipBO() throws Exception {
        // Inicia el test
        ...
        if(capturedText.equals(expectedText)) {
            System.out.println("testPartnerShipBO  [OK]");
        }
        else {
            System.out.println("testPartnerShipBO  [FAIL]");
        }
    }
