...
public class CorporateOperations {
    ...
    public void testCorporateOperations() throws Exception {
        ...
        String expectedText = "Descripción general";

        // Se valida que el texto es el esperado
        if(capturedText.equals(expectedText)) {
            System.out.println("testCorporateOperations  [OK]");
        }
        else {
            System.out.println("testCorporateOperations  [FAIL]");
        }
    }
