...
Característica: Como usuario administrador del backoffice quiero crear contactos
    ...
    Escenario: Editar un contacto desde el detalle de un comercio
        Dado hago click y sigo "#contacts .action-icon:first"
        Entonces espero a que aparezca el contenido dinámico "Editar contacto" en ".modal-title"
        Y el campo "name" debe contener "Artemio"
        Y relleno "surname" con "Valdivia"
        Y relleno "document" con "30116290"
        Y selecciono "Administración" de "area"
        Y relleno "position" con "Gerente"
        Y relleno "email" con "artemiov@yahoo.com"
        ...
        Entonces espero a que aparezca el contenido dinámico "Artemio Valdivia" en "#contacts"

    @javascript @loadBenefitsData
    Escenario: Editar un contacto desde el detalle de un comercio sin datos obligatorios
        Dado hago click y sigo "#contacts .action-icon:first"
        Entonces espero a que aparezca el contenido dinámico "Editar contacto" en ".modal-title"
        Y el campo "name" debe contener "Artemio"
        Y relleno "name" con " "
    ...
    @javascript @loadBenefitsData
    Escenario: Editar un contacto desde el detalle de un comercio sin respetar el máximo de caracteres
        Dado hago click y sigo "#contacts .action-icon:first"
        Entonces espero a que aparezca el contenido dinámico "Editar contacto" en ".modal-title"
        Y el campo "name" debe contener "Artemio"
