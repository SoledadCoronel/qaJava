...
Característica: Como usuario administrador del backoffice quiero crear un adjunto para un beneficio
    ...
    Escenario: Crear un adjunto desde la vista de un beneficio
        Dado hago click en "#visible-files .create-button"
        Y espero a que aparezca el contenido dinámico "Crear Adjunto para frontend" en ".modal-title"
        Y adjunto el archivo "test.txt" a "file-url"
        Y relleno "name" con "Nuevo términos y condiciones"
        Y relleno "description" con "Este es un nuevo tyt"
        Cuando presiono "Guardar"
        Entonces espero a que aparezca el contenido dinámico "Nuevo términos y condiciones" en "#visible-files"

    @javascript @loadBenefitsData
    Escenario: Crear adjunto desde el detalle de un beneficio sin datos obligatorios
        Dado hago click en "#visible-files .create-button"
        Entonces espero a que aparezca el contenido dinámico "Crear Adjunto para frontend" en ".modal-title"
        Cuando presiono "Guardar"
