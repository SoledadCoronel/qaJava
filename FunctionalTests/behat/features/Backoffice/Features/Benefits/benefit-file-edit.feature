...
Característica: Como usuario administrador del backoffice quiero editar un adjunto de un beneficio
    ...
    Escenario: Editar un adjunto desde la vista de un beneficio
        Dado hago click en "#files .model-edit:first"
        Y espero a que aparezca el contenido dinámico "Editar Adjunto" en ".modal-title"
        Y adjunto el archivo "test.txt" a "file-url"
        Y relleno "name" con "Contrato modificado"
        Y relleno "description" con "Este es un contrato modificado"
        Cuando presiono "Guardar"
        Entonces espero a que aparezca el contenido dinámico "Contrato modificado" en "#files"
