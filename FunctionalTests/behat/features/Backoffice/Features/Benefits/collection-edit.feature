...
Característica: Como usuario administrador del backoffice quiero crear un beneficio especial
    ...
    Antecedentes:
        ...
        Y espero a que aparezca el contenido dinámico "Colección Verano 2013" en ".table-collection-list"
        Y hago click y sigo ".action-icon:first"
        Y espero a que aparezca el contenido dinámico "Editar" en ".breadcrumb"
        Entonces espero a que aparezca el contenedor dinámico ".collection-form"

    @javascript @loadBenefitsBenefitData
    Escenario: Editar un especial
        ...
        Y selecciono todos los checkbox de ".selected-benefits"
        Y hago click en ".multi-select-button.right"
    ...
    @javascript @loadBenefitsBenefitData
    Escenario: Editar un especial sin datos obligatorios
        Y espero a que aparezca el contenedor dinámico ".field-translation-es"
        Y relleno "es_ES" con ""
        Y relleno "en_US" con ""
        Y relleno "pt_BR" con ""
