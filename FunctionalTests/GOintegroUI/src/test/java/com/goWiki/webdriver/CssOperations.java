...
public class CssOperations {
    ...
    @Test
    public void testCssOperations() throws Exception {
        // Inicia el test
        ...
        driver.findElement(By.cssSelector("a[title=\"CSS Operations\"] > span.app-name")).click();
        ...
        String expectedText = "CSS Operations";

        // Se valida que el texto es el esperado
        if(capturedText.equals(expectedText)) {
            System.out.println("testCssOperations  [OK]");
        }
        else {
            System.out.println("testCssOperations  [FAIL]");
        }
    }
