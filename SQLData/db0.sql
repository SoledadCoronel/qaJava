...
CREATE TABLE `account` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `billing_information` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `shipping_information` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `website` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `industry` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `number_of_employees` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rating` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `notes` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `is_regional` tinyint(1) NOT NULL,
  `is_development` tinyint(1) DEFAULT NULL,
  `signin_protocol` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `signin_host` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `signin_banner_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `logo_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `logo_url_footer` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `uses_registration` tinyint(1) DEFAULT NULL,
  `registration_message` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `registration_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `welcome_message` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `uses_welcome_message` tinyint(1) DEFAULT NULL,
  `html_login` longtext COLLATE utf8_unicode_ci,
  `default_background_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `default_bg_color_header_footer` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `default_border_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `default_font_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `button_background_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `button_font_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `icons_color` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `html_sign_up` longtext COLLATE utf8_unicode_ci,
  `disable` tinyint(1) NOT NULL,
  `unique_field` enum('usernameId','document','email') COLLATE utf8_unicode_ci DEFAULT NULL,
  `show_user_email` tinyint(1) DEFAULT NULL,
  `default_language_id` int(11) DEFAULT NULL,
  `salesforce_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `show_user_phone` tinyint(1) DEFAULT '0',
  `show_user_cellphone` tinyint(1) DEFAULT '0',
  `show_user_position` tinyint(1) DEFAULT '0',
  `show_user_chief` tinyint(1) DEFAULT '0',
  `show_user_department` tinyint(1) DEFAULT '0',
  `show_user_area` tinyint(1) DEFAULT '0',
  `show_user_location` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `IDX_7D3656A4727ACA70` (`parent_id`),
  KEY `IDX_7D3656A45602A942` (`default_language_id`),
  CONSTRAINT `FK_7D3656A45602A942` FOREIGN KEY (`default_language_id`) REFERENCES `language` (`id`),
  CONSTRAINT `FK_7D3656A4727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `account` (`id`) ON DELETE SET NULL
...
INSERT INTO `account` VALUES (21,NULL,'Standard Account','','','',NULL,'',NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `account_language` (
  ...
  KEY `IDX_AC1593039B6B5FBA` (`account_id`),
  KEY `IDX_AC15930382F1BAF4` (`language_id`),
  CONSTRAINT `FK_AC15930382F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_AC1593039B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `address` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_D4E6F819F16EA29` (`geographical_area_id`),
  CONSTRAINT `FK_D4E6F819F16EA29` FOREIGN KEY (`geographical_area_id`) REFERENCES `geographical_area` (`id`),
  CONSTRAINT `FK_D4E6F81BF396750` FOREIGN KEY (`id`) REFERENCES `location` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `api_client_version`
--

DROP TABLE IF EXISTS `api_client_version`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `api_client_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_98735005E237E06` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_client_version`
--

LOCK TABLES `api_client_version` WRITE;
/*!40000 ALTER TABLE `api_client_version` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_client_version` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `application` (
  ...
  `installation_limit` int(11) DEFAULT NULL,
  `application_type` enum('activityStream','news','articles','galleries','celebrations','tournaments','benefitsCategoriesMap','benefitsFilter','catalogs','recognitions') COLLATE utf8_unicode_ci DEFAULT NULL,
  `visible_without_login` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `application` VALUES (23,'application.article.name','application.article.description',NULL,NULL,'articles',0),(24,'application.news.name','application.news.description',NULL,NULL,'news',0),(25,'application.gallery.name','application.gallery.description',NULL,NULL,'galleries',0),(26,'application.activityStream.name','application.activityStream.description',NULL,NULL,'activityStream',0),(27,'application.celebrations.name','application.celebrations.description',NULL,NULL,'celebrations',0),(28,'application.tournaments.name','application.tournaments.description',NULL,NULL,'tournaments',0),(29,'application.benefitsFilter.name','application.benefitsFilter.description',NULL,NULL,'benefitsFilter',1),(30,'application.benefitsCategoriesMap.name','application.benefitsCategoriesMap.description',NULL,NULL,'benefitsCategoriesMap',1),(31,'application.catalogs.name','application.catalogs.description',NULL,NULL,'catalogs',1);
/*!40000 ALTER TABLE `application` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `application_widget`
--

DROP TABLE IF EXISTS `application_widget`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `application_widget` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `application_id` int(11) DEFAULT NULL,
  `widget_type` enum('platform_html_text','platform_banner','gallery_carousel','celebration_feed','benefits_ranking','benefits_category','benefits_collection','benefits_selected') COLLATE utf8_unicode_ci DEFAULT NULL,
  `visible_without_login` tinyint(1) NOT NULL,
  `source` enum('platform','application','benefits') COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_35CA12153E030ACD` (`application_id`),
  CONSTRAINT `FK_35CA12153E030ACD` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `application_widget`
--

LOCK TABLES `application_widget` WRITE;
/*!40000 ALTER TABLE `application_widget` DISABLE KEYS */;
INSERT INTO `application_widget` VALUES (17,NULL,'platform_html_text',1,'platform'),(18,NULL,'platform_banner',1,'platform'),(19,NULL,'benefits_category',1,'benefits'),(20,NULL,'benefits_ranking',1,'benefits'),(21,NULL,'benefits_collection',1,'benefits'),(22,NULL,'benefits_selected',1,'benefits'),(23,27,'celebration_feed',0,'application'),(24,25,'gallery_carousel',0,'application');
/*!40000 ALTER TABLE `application_widget` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `area` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_D7943D68FFE6496F` (`platform_id`),
  CONSTRAINT `FK_D7943D68FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
...
INSERT INTO `area` VALUES (33,3,'velit',0),(34,3,'laboris',1),(35,3,'duis',1),(36,3,'ullamco',0),(37,3,'dolore',1),(38,3,'consectetur',1),(39,3,'aliqua',1),(40,3,'cupidatat',1),(41,3,'Lorem',1),(42,3,'eiusmod',0),(43,3,'dolor',0),(44,3,'voluptate',1),(45,3,'commodo',0),(46,3,'mollit',1),(47,3,'labore',1),(48,3,'laborum',1),(49,3,'ullamco',0),(50,3,'excepteur',1),(51,3,'cillum',1),(52,3,'ipsum',1),(53,3,'consectetur',0),(54,3,'irure',0),(55,3,'quis',1),(56,3,'ullamco',1),(57,3,'laboris',0),(58,3,'ipsum',0),(59,3,'in',0),(60,3,'culpa',0),(61,3,'deserunt',1),(62,3,'dolore',0);
...
CREATE TABLE `article_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `article_app_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sorting` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_53A4EDAA1340B6AD` (`article_app_id`),
  CONSTRAINT `FK_53A4EDAA1340B6AD` FOREIGN KEY (`article_app_id`) REFERENCES `workspace_application` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `auth_group` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_A1E215B0FFE6496F` (`platform_id`),
  CONSTRAINT `FK_A1E215B0FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `auth_group_item`
--

DROP TABLE IF EXISTS `auth_group_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `auth_group_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `group_id` int(11) DEFAULT NULL,
  `item_class` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `item_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_284473DAFE54D947` (`group_id`),
  CONSTRAINT `FK_284473DAFE54D947` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `auth_group_item`
--

LOCK TABLES `auth_group_item` WRITE;
/*!40000 ALTER TABLE `auth_group_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `auth_group_item` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `auth_strategy`
--
...
CREATE TABLE `auth_strategy` (
  ...
  `identity_field` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `has_password` tinyint(1) NOT NULL,
  `recover_password` tinyint(1) NOT NULL,
  `login_lock_enabled` tinyint(1) DEFAULT NULL,
  `login_attempts` smallint(6) DEFAULT NULL,
  `login_attempt_period` smallint(6) DEFAULT NULL,
  `login_lock_time` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_30BCC26B9B6B5FBA` (`account_id`),
  UNIQUE KEY `UNIQ_30BCC26BFFE6496F` (`platform_id`),
  UNIQUE KEY `strategy_unique` (`account_id`,`platform_id`),
  CONSTRAINT `FK_30BCC26B9B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_30BCC26BFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `auth_strategy`
--

LOCK TABLES `auth_strategy` WRITE;
/*!40000 ALTER TABLE `auth_strategy` DISABLE KEYS */;
INSERT INTO `auth_strategy` VALUES (9,NULL,3,'usernameId',1,1,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `auth_strategy` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `backoffice_role` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_174177D65E237E06` (`name`),
  KEY `IDX_174177D6727ACA70` (`parent_id`),
  CONSTRAINT `FK_174177D6727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `backoffice_role` (`id`)
...
LOCK TABLES `backoffice_role` WRITE;
/*!40000 ALTER TABLE `backoffice_role` DISABLE KEYS */;
INSERT INTO `backoffice_role` VALUES (11,'ROLE_BACKOFFICE_ADMIN',NULL),(12,'ROLE_BACKOFFICE_SUPPORT',11),(13,'ROLE_BACKOFFICE_BASIC',NULL),(14,'ROLE_BACKOFFICE_BENEFITS',12),(15,'ROLE_BACKOFFICE_REWARDS',12);
/*!40000 ALTER TABLE `backoffice_role` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `backoffice_user_country`
--

DROP TABLE IF EXISTS `backoffice_user_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `backoffice_user_country` (
...
--
-- Dumping data for table `backoffice_user_country`
--

LOCK TABLES `backoffice_user_country` WRITE;
/*!40000 ALTER TABLE `backoffice_user_country` DISABLE KEYS */;
/*!40000 ALTER TABLE `backoffice_user_country` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `backoffice_user_role`
--

DROP TABLE IF EXISTS `backoffice_user_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `backoffice_user_role` (
  `user_id` int(11) NOT NULL,
...
--
-- Dumping data for table `backoffice_user_role`
--

LOCK TABLES `backoffice_user_role` WRITE;
/*!40000 ALTER TABLE `backoffice_user_role` DISABLE KEYS */;
INSERT INTO `backoffice_user_role` VALUES (3,11),(3,13),(4,11),(4,13);
/*!40000 ALTER TABLE `backoffice_user_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `batch_user_creation_task`
--

DROP TABLE IF EXISTS `batch_user_creation_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `batch_user_creation_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platform_id` int(11) DEFAULT NULL,
  `file_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `original_file_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `file_size` int(11) NOT NULL,
  `status` enum('PENDING','ERROR','IN_PROCESS','PROCESSED','PROCESSED_WITH_ERRORS') COLLATE utf8_unicode_ci DEFAULT NULL,
  `result` tinyint(1) DEFAULT NULL,
  `error_report` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_388BE74CFFE6496F` (`platform_id`),
  CONSTRAINT `FK_388BE74CFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `batch_user_creation_task`
--

LOCK TABLES `batch_user_creation_task` WRITE;
/*!40000 ALTER TABLE `batch_user_creation_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `batch_user_creation_task` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_area`
--

DROP TABLE IF EXISTS `benefits_area`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `benefits_area`
--

LOCK TABLES `benefits_area` WRITE;
/*!40000 ALTER TABLE `benefits_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_area` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit`
--

DROP TABLE IF EXISTS `benefits_benefit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `target_user_type_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_E0E22E91979B1AD6` (`company_id`),
  KEY `IDX_E0E22E916C066AFE` (`target_user_type_id`),
  KEY `IDX_E0E22E914C7C611F` (`discount_id`),
  CONSTRAINT `FK_E0E22E914C7C611F` FOREIGN KEY (`discount_id`) REFERENCES `benefits_discount` (`id`),
  CONSTRAINT `FK_E0E22E916C066AFE` FOREIGN KEY (`target_user_type_id`) REFERENCES `target_user_type` (`id`),
  CONSTRAINT `FK_E0E22E91979B1AD6` FOREIGN KEY (`company_id`) REFERENCES `benefits_company` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit`
--

LOCK TABLES `benefits_benefit` WRITE;
/*!40000 ALTER TABLE `benefits_benefit` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_category`
--

DROP TABLE IF EXISTS `benefits_benefit_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_category` (
  `benefit_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`category_id`),
  KEY `IDX_9BE5D604B517B89` (`benefit_id`),
  KEY `IDX_9BE5D60412469DE2` (`category_id`),
  CONSTRAINT `FK_9BE5D60412469DE2` FOREIGN KEY (`category_id`) REFERENCES `benefits_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_9BE5D604B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_category`
--

LOCK TABLES `benefits_benefit_category` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_collection`
--

DROP TABLE IF EXISTS `benefits_benefit_collection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_collection` (
...
--
-- Dumping data for table `benefits_benefit_collection`
--

LOCK TABLES `benefits_benefit_collection` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_collection` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_collection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_daily_view`
--

DROP TABLE IF EXISTS `benefits_benefit_daily_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_daily_view` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `benefit_id` int(11) NOT NULL,
  `platform_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_benefit_daily_view`
--

LOCK TABLES `benefits_benefit_daily_view` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_daily_view` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_daily_view` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_day`
--

DROP TABLE IF EXISTS `benefits_benefit_day`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_day` (
  `benefit_id` int(11) NOT NULL,
  `day_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`day_id`),
  KEY `IDX_53A6AE57B517B89` (`benefit_id`),
  KEY `IDX_53A6AE579C24126` (`day_id`),
  CONSTRAINT `FK_53A6AE579C24126` FOREIGN KEY (`day_id`) REFERENCES `day` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_53A6AE57B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_day`
--

LOCK TABLES `benefits_benefit_day` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_day` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_exclusive_platform`
--

DROP TABLE IF EXISTS `benefits_benefit_exclusive_platform`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_exclusive_platform` (
  `benefit_id` int(11) NOT NULL,
  `platform_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_benefit_exclusive_platform`
--

LOCK TABLES `benefits_benefit_exclusive_platform` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_exclusive_platform` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_exclusive_platform` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_file`
--

DROP TABLE IF EXISTS `benefits_benefit_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_file` (
  `id` int(11) NOT NULL,
  `benefit_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8_unicode_ci,
  `active` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_89296784B517B89` (`benefit_id`),
  CONSTRAINT `FK_89296784B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`),
  CONSTRAINT `FK_89296784BF396750` FOREIGN KEY (`id`) REFERENCES `public_file` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_file`
--

LOCK TABLES `benefits_benefit_file` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_file` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_image`
--

DROP TABLE IF EXISTS `benefits_benefit_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_image` (
  `id` int(11) NOT NULL,
  `benefit_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `benefits_benefit_image`
--

LOCK TABLES `benefits_benefit_image` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_image` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_payment_method`
--

DROP TABLE IF EXISTS `benefits_benefit_payment_method`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_payment_method` (
  `benefit_id` int(11) NOT NULL,
  `payment_method_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`payment_method_id`),
  KEY `IDX_94A92CD7B517B89` (`benefit_id`),
  KEY `IDX_94A92CD75AA1164F` (`payment_method_id`),
  CONSTRAINT `FK_94A92CD75AA1164F` FOREIGN KEY (`payment_method_id`) REFERENCES `benefits_payment_method` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_94A92CD7B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_payment_method`
--

LOCK TABLES `benefits_benefit_payment_method` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_payment_method` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_payment_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_redeeming_method`
--

DROP TABLE IF EXISTS `benefits_benefit_redeeming_method`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_redeeming_method` (
  `benefit_id` int(11) NOT NULL,
  `redeeming_method_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`redeeming_method_id`),
  KEY `IDX_2E35541AB517B89` (`benefit_id`),
  KEY `IDX_2E35541A5A5CFF42` (`redeeming_method_id`),
  CONSTRAINT `FK_2E35541A5A5CFF42` FOREIGN KEY (`redeeming_method_id`) REFERENCES `benefits_redeeming_method` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_2E35541AB517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_redeeming_method`
--

LOCK TABLES `benefits_benefit_redeeming_method` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_redeeming_method` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_redeeming_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_restricted_platform`
--

DROP TABLE IF EXISTS `benefits_benefit_restricted_platform`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_restricted_platform` (
  `benefit_id` int(11) NOT NULL,
  `platform_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`platform_id`),
...
--
-- Dumping data for table `benefits_benefit_restricted_platform`
--

LOCK TABLES `benefits_benefit_restricted_platform` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_restricted_platform` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_restricted_platform` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_store`
--

DROP TABLE IF EXISTS `benefits_benefit_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_store` (
  `benefit_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`benefit_id`,`store_id`),
  KEY `IDX_830B97BB517B89` (`benefit_id`),
  KEY `IDX_830B97BB092A811` (`store_id`),
  CONSTRAINT `FK_830B97BB092A811` FOREIGN KEY (`store_id`) REFERENCES `benefits_store` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_830B97BB517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_store`
--

LOCK TABLES `benefits_benefit_store` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_tag`
--

DROP TABLE IF EXISTS `benefits_benefit_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_tag` (
  `benefit_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_benefit_tag`
--

LOCK TABLES `benefits_benefit_tag` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_tag` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_benefit_visible_file`
--

DROP TABLE IF EXISTS `benefits_benefit_visible_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_benefit_visible_file` (
  `id` int(11) NOT NULL,
  `benefit_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8_unicode_ci,
  `active` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_CDE7CA1AB517B89` (`benefit_id`),
  CONSTRAINT `FK_CDE7CA1AB517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`),
  CONSTRAINT `FK_CDE7CA1ABF396750` FOREIGN KEY (`id`) REFERENCES `public_file` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_benefit_visible_file`
--

LOCK TABLES `benefits_benefit_visible_file` WRITE;
/*!40000 ALTER TABLE `benefits_benefit_visible_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_benefit_visible_file` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_category`
--

DROP TABLE IF EXISTS `benefits_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_CF0DEC8727ACA70` (`parent_id`),
  CONSTRAINT `FK_CF0DEC8727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `benefits_category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_category`
--

LOCK TABLES `benefits_category` WRITE;
/*!40000 ALTER TABLE `benefits_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_category_queue`
--

DROP TABLE IF EXISTS `benefits_category_queue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_category_queue` (
  `category_id` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`category_id`),
  CONSTRAINT `FK_B1C721DD12469DE2` FOREIGN KEY (`category_id`) REFERENCES `benefits_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_category_queue`
--

LOCK TABLES `benefits_category_queue` WRITE;
/*!40000 ALTER TABLE `benefits_category_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_category_queue` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_category_restricted_platforms`
--

DROP TABLE IF EXISTS `benefits_category_restricted_platforms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_category_restricted_platforms` (
  `category_id` int(11) NOT NULL,
  `platform_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_category_restricted_platforms`
--

LOCK TABLES `benefits_category_restricted_platforms` WRITE;
/*!40000 ALTER TABLE `benefits_category_restricted_platforms` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_category_restricted_platforms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_category_tag`
--

DROP TABLE IF EXISTS `benefits_category_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_category_tag` (
  `category_id` int(11) NOT NULL,
  `tag_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_category_tag`
--

LOCK TABLES `benefits_category_tag` WRITE;
/*!40000 ALTER TABLE `benefits_category_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_category_tag` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_category_translations`
--

DROP TABLE IF EXISTS `benefits_category_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_category_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `IDX_FD7ABEEF232D562B` (`object_id`),
  CONSTRAINT `FK_FD7ABEEF232D562B` FOREIGN KEY (`object_id`) REFERENCES `benefits_category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_category_translations`
--

LOCK TABLES `benefits_category_translations` WRITE;
/*!40000 ALTER TABLE `benefits_category_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_category_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_collection`
--

DROP TABLE IF EXISTS `benefits_collection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_collection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `valid_until` date DEFAULT NULL,
...
--
-- Dumping data for table `benefits_collection`
--

LOCK TABLES `benefits_collection` WRITE;
/*!40000 ALTER TABLE `benefits_collection` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_collection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_collection_exclusive_platform`
--

DROP TABLE IF EXISTS `benefits_collection_exclusive_platform`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_collection_exclusive_platform` (
  `collection_id` int(11) NOT NULL,
  `platform_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_collection_exclusive_platform`
--

LOCK TABLES `benefits_collection_exclusive_platform` WRITE;
/*!40000 ALTER TABLE `benefits_collection_exclusive_platform` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_collection_exclusive_platform` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_collection_translations`
--

DROP TABLE IF EXISTS `benefits_collection_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_collection_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_5A7FFFB3232D562B` (`object_id`),
  CONSTRAINT `FK_5A7FFFB3232D562B` FOREIGN KEY (`object_id`) REFERENCES `benefits_collection` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_collection_translations`
--

LOCK TABLES `benefits_collection_translations` WRITE;
/*!40000 ALTER TABLE `benefits_collection_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_collection_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_company`
--

DROP TABLE IF EXISTS `benefits_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_company` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `geographical_area_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `lat_lon` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_F3D627C19F16EA29` (`geographical_area_id`),
  CONSTRAINT `FK_F3D627C19F16EA29` FOREIGN KEY (`geographical_area_id`) REFERENCES `geographical_area` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_company`
--

LOCK TABLES `benefits_company` WRITE;
/*!40000 ALTER TABLE `benefits_company` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_company` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_company_category`
--

DROP TABLE IF EXISTS `benefits_company_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_company_category` (
  `company_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`company_id`,`category_id`),
  KEY `IDX_2F967D2D979B1AD6` (`company_id`),
  KEY `IDX_2F967D2D12469DE2` (`category_id`),
  CONSTRAINT `FK_2F967D2D12469DE2` FOREIGN KEY (`category_id`) REFERENCES `benefits_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_2F967D2D979B1AD6` FOREIGN KEY (`company_id`) REFERENCES `benefits_company` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_company_category`
--

LOCK TABLES `benefits_company_category` WRITE;
/*!40000 ALTER TABLE `benefits_company_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_company_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_company_image`
--

DROP TABLE IF EXISTS `benefits_company_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_company_image` (
  `id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `benefits_company_image`
--

LOCK TABLES `benefits_company_image` WRITE;
/*!40000 ALTER TABLE `benefits_company_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_company_image` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_company_payment_method`
--

DROP TABLE IF EXISTS `benefits_company_payment_method`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_company_payment_method` (
  `payment_method_id` int(11) NOT NULL,
  `company_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_company_payment_method`
--

LOCK TABLES `benefits_company_payment_method` WRITE;
/*!40000 ALTER TABLE `benefits_company_payment_method` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_company_payment_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_company_tag`
--

DROP TABLE IF EXISTS `benefits_company_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_company_tag` (
  `company_id` int(11) NOT NULL,
  `tag_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_company_tag`
--

LOCK TABLES `benefits_company_tag` WRITE;
/*!40000 ALTER TABLE `benefits_company_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_company_tag` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_contact`
--

DROP TABLE IF EXISTS `benefits_contact`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_F00BC8B6979B1AD6` (`company_id`),
  KEY `IDX_F00BC8B6BD0F409C` (`area_id`),
  CONSTRAINT `FK_F00BC8B6979B1AD6` FOREIGN KEY (`company_id`) REFERENCES `benefits_company` (`id`),
  CONSTRAINT `FK_F00BC8B6BD0F409C` FOREIGN KEY (`area_id`) REFERENCES `benefits_area` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_contact`
--

LOCK TABLES `benefits_contact` WRITE;
/*!40000 ALTER TABLE `benefits_contact` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_contact` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_discount`
--

DROP TABLE IF EXISTS `benefits_discount`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_discount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `benefits_discount`
--

LOCK TABLES `benefits_discount` WRITE;
/*!40000 ALTER TABLE `benefits_discount` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_discount` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_filter_application_category`
--

DROP TABLE IF EXISTS `benefits_filter_application_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_filter_application_category` (
  `benefits_filter_application_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  PRIMARY KEY (`benefits_filter_application_id`,`category_id`),
  KEY `IDX_861A15BA4113423F` (`benefits_filter_application_id`),
  KEY `IDX_861A15BA12469DE2` (`category_id`),
  CONSTRAINT `FK_861A15BA12469DE2` FOREIGN KEY (`category_id`) REFERENCES `benefits_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_861A15BA4113423F` FOREIGN KEY (`benefits_filter_application_id`) REFERENCES `workspace_application` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_filter_application_category`
--

LOCK TABLES `benefits_filter_application_category` WRITE;
/*!40000 ALTER TABLE `benefits_filter_application_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_filter_application_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_filter_application_location`
--

DROP TABLE IF EXISTS `benefits_filter_application_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_filter_application_location` (
  `benefits_filter_application_id` int(11) NOT NULL,
...
--
-- Dumping data for table `benefits_filter_application_location`
--

LOCK TABLES `benefits_filter_application_location` WRITE;
/*!40000 ALTER TABLE `benefits_filter_application_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_filter_application_location` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_gallery`
--

DROP TABLE IF EXISTS `benefits_gallery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_gallery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `active` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `benefits_gallery`
--

LOCK TABLES `benefits_gallery` WRITE;
/*!40000 ALTER TABLE `benefits_gallery` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_gallery` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_gallery_benefit`
--

DROP TABLE IF EXISTS `benefits_gallery_benefit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_gallery_benefit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `benefit_id` int(11) NOT NULL,
  `sorting` int(11) NOT NULL,
  `gallery_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_470E2F99B517B89` (`benefit_id`),
  KEY `IDX_470E2F994E7AF8F` (`gallery_id`),
  CONSTRAINT `FK_470E2F994E7AF8F` FOREIGN KEY (`gallery_id`) REFERENCES `benefits_gallery` (`id`),
  CONSTRAINT `FK_470E2F99B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_gallery_benefit`
--

LOCK TABLES `benefits_gallery_benefit` WRITE;
/*!40000 ALTER TABLE `benefits_gallery_benefit` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_gallery_benefit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_payment_machine`
--

DROP TABLE IF EXISTS `benefits_payment_machine`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_payment_machine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_2FB3BFC0B092A811` (`store_id`),
  CONSTRAINT `FK_2FB3BFC0B092A811` FOREIGN KEY (`store_id`) REFERENCES `benefits_store_outlet` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_payment_machine`
--

LOCK TABLES `benefits_payment_machine` WRITE;
/*!40000 ALTER TABLE `benefits_payment_machine` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_payment_machine` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_payment_method`
--

DROP TABLE IF EXISTS `benefits_payment_method`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_payment_method` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `benefits_payment_method`
--

LOCK TABLES `benefits_payment_method` WRITE;
/*!40000 ALTER TABLE `benefits_payment_method` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_payment_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_payment_method_translations`
--

DROP TABLE IF EXISTS `benefits_payment_method_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_payment_method_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_936942CA232D562B` (`object_id`),
  CONSTRAINT `FK_936942CA232D562B` FOREIGN KEY (`object_id`) REFERENCES `benefits_payment_method` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_payment_method_translations`
--

LOCK TABLES `benefits_payment_method_translations` WRITE;
/*!40000 ALTER TABLE `benefits_payment_method_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_payment_method_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_redeeming_method`
--

DROP TABLE IF EXISTS `benefits_redeeming_method`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_redeeming_method` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `benefits_redeeming_method`
--

LOCK TABLES `benefits_redeeming_method` WRITE;
/*!40000 ALTER TABLE `benefits_redeeming_method` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_redeeming_method` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_redeeming_method_translations`
--

DROP TABLE IF EXISTS `benefits_redeeming_method_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_redeeming_method_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_5CCC0FC232D562B` (`object_id`),
  CONSTRAINT `FK_5CCC0FC232D562B` FOREIGN KEY (`object_id`) REFERENCES `benefits_redeeming_method` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_redeeming_method_translations`
--

LOCK TABLES `benefits_redeeming_method_translations` WRITE;
/*!40000 ALTER TABLE `benefits_redeeming_method_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_redeeming_method_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store`
--

DROP TABLE IF EXISTS `benefits_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `company_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `company_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `benefits_store`
--

LOCK TABLES `benefits_store` WRITE;
/*!40000 ALTER TABLE `benefits_store` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store_online`
--

DROP TABLE IF EXISTS `benefits_store_online`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store_online` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_BB68EF99BF396750` FOREIGN KEY (`id`) REFERENCES `benefits_store` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_store_online`
--

LOCK TABLES `benefits_store_online` WRITE;
/*!40000 ALTER TABLE `benefits_store_online` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store_online` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store_online_geographical_area`
--

DROP TABLE IF EXISTS `benefits_store_online_geographical_area`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store_online_geographical_area` (
...
--
-- Dumping data for table `benefits_store_online_geographical_area`
--

LOCK TABLES `benefits_store_online_geographical_area` WRITE;
/*!40000 ALTER TABLE `benefits_store_online_geographical_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store_online_geographical_area` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store_outlet`
--

DROP TABLE IF EXISTS `benefits_store_outlet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store_outlet` (
  `id` int(11) NOT NULL,
  `geographical_area_id` int(11) NOT NULL,
  `formatted_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `street_number` int(11) NOT NULL,
  ...
  `lat_lon` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_B67A0DA89F16EA29` (`geographical_area_id`),
  CONSTRAINT `FK_B67A0DA89F16EA29` FOREIGN KEY (`geographical_area_id`) REFERENCES `geographical_area` (`id`),
  CONSTRAINT `FK_B67A0DA8BF396750` FOREIGN KEY (`id`) REFERENCES `benefits_store` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_store_outlet`
--

LOCK TABLES `benefits_store_outlet` WRITE;
/*!40000 ALTER TABLE `benefits_store_outlet` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store_outlet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store_phone`
--

DROP TABLE IF EXISTS `benefits_store_phone`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store_phone` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_71CC446FBF396750` FOREIGN KEY (`id`) REFERENCES `benefits_store` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `benefits_store_phone`
--

LOCK TABLES `benefits_store_phone` WRITE;
/*!40000 ALTER TABLE `benefits_store_phone` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store_phone` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_store_phone_geographical_area`
--

DROP TABLE IF EXISTS `benefits_store_phone_geographical_area`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_store_phone_geographical_area` (
...
--
-- Dumping data for table `benefits_store_phone_geographical_area`
--

LOCK TABLES `benefits_store_phone_geographical_area` WRITE;
/*!40000 ALTER TABLE `benefits_store_phone_geographical_area` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_store_phone_geographical_area` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `benefits_tag`
--

DROP TABLE IF EXISTS `benefits_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `benefits_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `benefits_tag`
--

LOCK TABLES `benefits_tag` WRITE;
/*!40000 ALTER TABLE `benefits_tag` DISABLE KEYS */;
/*!40000 ALTER TABLE `benefits_tag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `carousel_content` (
  ...
  PRIMARY KEY (`carousel_id`,`content_id`),
  KEY `IDX_9C6AE587C1CE5B98` (`carousel_id`),
  KEY `IDX_9C6AE58784A0A3ED` (`content_id`),
  CONSTRAINT `FK_9C6AE58784A0A3ED` FOREIGN KEY (`content_id`) REFERENCES `gallery_content` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_9C6AE587C1CE5B98` FOREIGN KEY (`carousel_id`) REFERENCES `environment_carousel_widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `carousel_content` WRITE;
/*!40000 ALTER TABLE `carousel_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `carousel_content` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_automation`
--

DROP TABLE IF EXISTS `celebration_automation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_automation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `celebration_automation`
--

LOCK TABLES `celebration_automation` WRITE;
/*!40000 ALTER TABLE `celebration_automation` DISABLE KEYS */;
INSERT INTO `celebration_automation` VALUES (3,'categories.automation.birthday');
/*!40000 ALTER TABLE `celebration_automation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_category`
--

DROP TABLE IF EXISTS `celebration_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `celebration_app_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sorting` int(11) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_AADFC83B3E418D11` (`celebration_app_id`),
  CONSTRAINT `FK_AADFC83B3E418D11` FOREIGN KEY (`celebration_app_id`) REFERENCES `workspace_application` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `celebration_category`
--

LOCK TABLES `celebration_category` WRITE;
/*!40000 ALTER TABLE `celebration_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_category_automation`
--

DROP TABLE IF EXISTS `celebration_category_automation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_category_automation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `automation_id` int(11) NOT NULL,
  `disabled` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_3A289B3712469DE2` (`category_id`),
  KEY `IDX_3A289B37D1C5DDC3` (`automation_id`),
  CONSTRAINT `FK_3A289B3712469DE2` FOREIGN KEY (`category_id`) REFERENCES `celebration_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_3A289B37D1C5DDC3` FOREIGN KEY (`automation_id`) REFERENCES `celebration_automation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `celebration_category_automation`
--

LOCK TABLES `celebration_category_automation` WRITE;
/*!40000 ALTER TABLE `celebration_category_automation` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_category_automation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_event`
--

DROP TABLE IF EXISTS `celebration_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_event` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4FCD494912469DE2` (`category_id`),
  KEY `IDX_4FCD49493E418D11` (`celebration_app_id`),
  KEY `IDX_4FCD49493DA5256D` (`image_id`),
  CONSTRAINT `FK_4FCD494912469DE2` FOREIGN KEY (`category_id`) REFERENCES `celebration_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_4FCD49493DA5256D` FOREIGN KEY (`image_id`) REFERENCES `file` (`id`),
  CONSTRAINT `FK_4FCD49493E418D11` FOREIGN KEY (`celebration_app_id`) REFERENCES `workspace_application` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `celebration_event`
--

LOCK TABLES `celebration_event` WRITE;
/*!40000 ALTER TABLE `celebration_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_event` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_event_birthday`
--

DROP TABLE IF EXISTS `celebration_event_birthday`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_event_birthday` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `celebration_event_birthday`
--

LOCK TABLES `celebration_event_birthday` WRITE;
/*!40000 ALTER TABLE `celebration_event_birthday` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_event_birthday` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_event_celebration`
--

DROP TABLE IF EXISTS `celebration_event_celebration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_event_celebration` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_709E5014BF396750` FOREIGN KEY (`id`) REFERENCES `celebration_event` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `celebration_event_celebration`
--

LOCK TABLES `celebration_event_celebration` WRITE;
/*!40000 ALTER TABLE `celebration_event_celebration` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_event_celebration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `celebration_event_user`
--

DROP TABLE IF EXISTS `celebration_event_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `celebration_event_user` (
...
--
-- Dumping data for table `celebration_event_user`
--

LOCK TABLES `celebration_event_user` WRITE;
/*!40000 ALTER TABLE `celebration_event_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `celebration_event_user` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `comment` (
  ...
  KEY `IDX_9474526CFFE6496F` (`platform_id`),
  KEY `IDX_9474526C23EDC87` (`subject_id`),
  CONSTRAINT `FK_9474526CF675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_9474526CFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `content_tag` (
  ...
  `content_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_B662E176BAD26311` (`tag_id`),
  KEY `IDX_B662E176F675F31B` (`author_id`),
  KEY `IDX_B662E17684A0A3ED` (`content_id`),
  CONSTRAINT `FK_B662E176BAD26311` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`),
  CONSTRAINT `FK_B662E176F675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `country` VALUES (26,'Argentina',-21.7808136,-53.637481,-55.0577146,-73.56036019999999,'AR'),(27,'Brasil',5.271602,-29.3450235,-33.7517484,-73.982817,'BR'),(28,'Chile',-17.4983292,-66.4182017,-55.9797808,-109.4548806,'CL'),(29,'Colombia',13.39735,-66.851923,-4.22711,-81.73593,'CO'),(30,'Perú',-0.038777,-68.652329,-18.3515802,-81.32850409999999,'PE'),(31,'México',32.7187629,-86.7105711,14.5345485,-118.36443,'MX'),(32,'Uruguay',-30.085215,-53.1842925,-35.0314185,-58.43915,'UY');
...
CREATE TABLE `country_translations` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_CA145695232D562B` (`object_id`),
  CONSTRAINT `FK_CA145695232D562B` FOREIGN KEY (`object_id`) REFERENCES `country` (`id`) ON DELETE CASCADE
...
INSERT INTO `country_translations` VALUES (76,26,'es_ES','name','Argentina'),(77,26,'en_US','name','Argentina'),(78,26,'pt_BR','name','Argentina'),(79,27,'es_ES','name','Brasil'),(80,27,'en_US','name','Brasil'),(81,27,'pt_BR','name','Brasil'),(82,28,'es_ES','name','Chile'),(83,28,'en_US','name','Chile'),(84,28,'pt_BR','name','Chile'),(85,29,'es_ES','name','Colombia'),(86,29,'en_US','name','Colombia'),(87,29,'pt_BR','name','Colômbia'),(88,30,'es_ES','name','Perú'),(89,30,'en_US','name','Perú'),(90,30,'pt_BR','name','Peru'),(91,31,'es_ES','name','México'),(92,31,'en_US','name','México'),(93,31,'pt_BR','name','México'),(94,32,'es_ES','name','Uruguay'),(95,32,'en_US','name','Uruguay'),(96,32,'pt_BR','name','Uruguai');
/*!40000 ALTER TABLE `country_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `craue_geo_postalcode`
--

DROP TABLE IF EXISTS `craue_geo_postalcode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `craue_geo_postalcode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `postal_code_idx` (`country`,`postal_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `craue_geo_postalcode`
--

LOCK TABLES `craue_geo_postalcode` WRITE;
/*!40000 ALTER TABLE `craue_geo_postalcode` DISABLE KEYS */;
/*!40000 ALTER TABLE `craue_geo_postalcode` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `department` (
  ...
  `active` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_CD1DE18ABD0F409C` (`area_id`),
  CONSTRAINT `FK_CD1DE18ABD0F409C` FOREIGN KEY (`area_id`) REFERENCES `area` (`id`)
...
INSERT INTO `department` VALUES (14,34,'Finazas',1),(15,34,'Administración',1),(16,34,'Recursos humanos',1),(17,34,'Ventas',0),(18,34,'Logística',1),(19,35,'Tecnología',1),(20,35,'Diseño',1),(21,35,'Recursos humanos',0),(22,35,'Administración',1),(23,35,'Finazas',1),(24,35,'Stock',1),(25,35,'Comerciales',1),(26,35,'Correo',0);
...
CREATE TABLE `environment` (
  ...
  `protocol` varchar(7) COLLATE utf8_unicode_ci DEFAULT NULL,
  `home_layout` enum('fullGrid','wallGrid') COLLATE utf8_unicode_ci DEFAULT NULL,
  `hidden` tinyint(1) NOT NULL DEFAULT '0',
  `access_type` enum('publicWithLogin','publicWithoutLogin') COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4626DE22FFE6496F` (`platform_id`),
  CONSTRAINT `FK_4626DE22FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `environment_carousel_widget`
--

DROP TABLE IF EXISTS `environment_carousel_widget`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `environment_carousel_widget` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_1FD6279ABF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `environment_carousel_widget`
--

LOCK TABLES `environment_carousel_widget` WRITE;
/*!40000 ALTER TABLE `environment_carousel_widget` DISABLE KEYS */;
/*!40000 ALTER TABLE `environment_carousel_widget` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `environment_celebration_feed_widget`
--

DROP TABLE IF EXISTS `environment_celebration_feed_widget`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `environment_celebration_feed_widget` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_586EE04ABF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `environment_celebration_feed_widget`
--

LOCK TABLES `environment_celebration_feed_widget` WRITE;
/*!40000 ALTER TABLE `environment_celebration_feed_widget` DISABLE KEYS */;
/*!40000 ALTER TABLE `environment_celebration_feed_widget` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `event` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_3BAE0AA79D32F035` (`action_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `feed_category` (
  ...
  KEY `IDX_26998E6651A5BC03` (`feed_id`),
  KEY `IDX_26998E6612469DE2` (`category_id`),
  CONSTRAINT `FK_26998E6612469DE2` FOREIGN KEY (`category_id`) REFERENCES `celebration_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_26998E6651A5BC03` FOREIGN KEY (`feed_id`) REFERENCES `environment_celebration_feed_widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `feed_category` WRITE;
/*!40000 ALTER TABLE `feed_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `feed_category` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `file` (
  ...
  `mime_format` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `size` int(11) NOT NULL,
  `tmp_filename` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  ...
  KEY `IDX_8C9F3610FFE6496F` (`platform_id`),
  CONSTRAINT `FK_8C9F36107E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_8C9F3610FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `follow` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_68344470F675F31B1E14D3F223EDC87` (`author_id`,`subject_type`,`subject_id`),
  KEY `IDX_68344470F675F31B` (`author_id`),
  KEY `IDX_68344470FFE6496F` (`platform_id`),
  KEY `IDX_6834447023EDC87` (`subject_id`),
  CONSTRAINT `FK_68344470F675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_68344470FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gallery_album` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gallery_app_id` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sorting` int(11) NOT NULL,
  `cover_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_DD05BE60922726E9` (`cover_id`),
  KEY `IDX_DD05BE60DB04CD8F` (`gallery_app_id`),
  CONSTRAINT `FK_DD05BE60922726E9` FOREIGN KEY (`cover_id`) REFERENCES `gallery_content` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_DD05BE60DB04CD8F` FOREIGN KEY (`gallery_app_id`) REFERENCES `workspace_application` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gallery_album` VALUES (3,20,'Empire',0,NULL),(4,20,'Rebel Alliance',0,NULL);
...
CREATE TABLE `gallery_content` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_C6BF71817E3C61F9` (`owner_id`),
  KEY `IDX_C6BF71811137ABCF` (`album_id`),
  KEY `IDX_C6BF718184A0A3ED` (`content_id`),
  CONSTRAINT `FK_C6BF71811137ABCF` FOREIGN KEY (`album_id`) REFERENCES `gallery_album` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_C6BF71817E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_C6BF718184A0A3ED` FOREIGN KEY (`content_id`) REFERENCES `file` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gallery_content` VALUES (51,10,3,53,'Star Wars 0',0,'picture'),(52,10,3,54,'Star Wars 1',0,'picture'),(53,10,3,55,'Star Wars 2',0,'picture'),(54,10,3,56,'Star Wars 3',0,'picture'),(55,10,3,57,'Star Wars 4',0,'picture'),(56,10,3,58,'Star Wars 5',0,'picture'),(57,10,3,59,'Star Wars 6',0,'picture'),(58,10,3,60,'Star Wars 7',0,'picture'),(59,10,3,61,'Star Wars 8',0,'picture'),(60,10,3,62,'Star Wars 9',0,'picture'),(61,10,3,63,'Star Wars 10',0,'picture'),(62,10,3,64,'Star Wars 11',0,'picture'),(63,10,3,65,'Star Wars 12',0,'picture'),(64,10,3,66,'Star Wars 13',0,'picture'),(65,10,3,67,'Star Wars 14',0,'picture'),(66,10,3,68,'Star Wars 15',0,'picture'),(67,10,3,69,'Star Wars 16',0,'picture'),(68,10,3,70,'Star Wars 17',0,'picture'),(69,10,3,71,'Star Wars 18',0,'picture'),(70,10,3,72,'Star Wars 19',0,'picture'),(71,10,3,73,'Star Wars 20',0,'picture'),(72,10,3,74,'Star Wars 21',0,'picture'),(73,10,3,75,'Star Wars 22',0,'picture'),(74,10,3,76,'Star Wars 23',0,'picture'),(75,10,3,77,'Star Wars 24',0,'picture'),(76,10,4,78,'Star Wars 0',0,'picture'),(77,10,4,79,'Star Wars 1',0,'picture'),(78,10,4,80,'Star Wars 2',0,'picture'),(79,10,4,81,'Star Wars 3',0,'picture'),(80,10,4,82,'Star Wars 4',0,'picture'),(81,10,4,83,'Star Wars 5',0,'picture'),(82,10,4,84,'Star Wars 6',0,'picture'),(83,10,4,85,'Star Wars 7',0,'picture'),(84,10,4,86,'Star Wars 8',0,'picture'),(85,10,4,87,'Star Wars 9',0,'picture'),(86,10,4,88,'Star Wars 10',0,'picture'),(87,10,4,89,'Star Wars 11',0,'picture'),(88,10,4,90,'Star Wars 12',0,'picture'),(89,10,4,91,'Star Wars 13',0,'picture'),(90,10,4,92,'Star Wars 14',0,'picture'),(91,10,4,93,'Star Wars 15',0,'picture'),(92,10,4,94,'Star Wars 16',0,'picture'),(93,10,4,95,'Star Wars 17',0,'picture'),(94,10,4,96,'Star Wars 18',0,'picture'),(95,10,4,97,'Star Wars 19',0,'picture'),(96,10,4,98,'Star Wars 20',0,'picture'),(97,10,4,99,'Star Wars 21',0,'picture'),(98,10,4,100,'Star Wars 22',0,'picture'),(99,10,4,101,'Star Wars 23',0,'picture'),(100,10,4,102,'Star Wars 24',0,'picture');
...
CREATE TABLE `geographical_area` (
  ...
  `parent_id` int(11) DEFAULT NULL,
  `country_id` int(11) NOT NULL,
  `type` enum('administrative_area_level_1','administrative_area_level_2','administrative_area_level_3','locality','sublocality','sublocality_level_1','sublocality_level_2','neighborhood','country') COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `sw_lng` double NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_C3AB7498727ACA70` (`parent_id`),
  KEY `IDX_C3AB7498F92F3E70` (`country_id`),
  CONSTRAINT `FK_C3AB7498727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `geographical_area` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_C3AB7498BF396750` FOREIGN KEY (`id`) REFERENCES `location` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_C3AB7498F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `group_access` (
  ...
  KEY `IDX_D5EFF384FE54D947` (`group_id`),
  KEY `IDX_D5EFF3844FEA67CF` (`access_id`),
  CONSTRAINT `FK_D5EFF3844FEA67CF` FOREIGN KEY (`access_id`) REFERENCES `access` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_D5EFF384FE54D947` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `help_center_message`
--

DROP TABLE IF EXISTS `help_center_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `help_center_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `surname` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `document` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `reason` enum('CONSULTATION','INCONVENIENT','SUGGESTION') COLLATE utf8_unicode_ci DEFAULT NULL,
  `issue` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `sended_at` datetime DEFAULT NULL,
  `account_id` int(11) DEFAULT NULL,
  `platform_id` int(11) DEFAULT NULL,
  `issue_type` enum('discount','catalog','platform') COLLATE utf8_unicode_ci DEFAULT 'platform',
  PRIMARY KEY (`id`),
  KEY `IDX_7A2A3B5C9B6B5FBA` (`account_id`),
  KEY `FK_7A2A3B5CFFE6496F` (`platform_id`),
  CONSTRAINT `FK_7A2A3B5C9B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_7A2A3B5CFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `help_center_message`
--

LOCK TABLES `help_center_message` WRITE;
/*!40000 ALTER TABLE `help_center_message` DISABLE KEYS */;
/*!40000 ALTER TABLE `help_center_message` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `invitation_request` (
  ...
  `status` enum('pending','approved','rejected','canceled') COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `gender` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cellphone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dependent_user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_406AA1EAAE9F1A7D` (`dependent_user_id`),
  KEY `IDX_406AA1EAD526A7D3` (`parent_user_id`),
  CONSTRAINT `FK_406AA1EAAE9F1A7D` FOREIGN KEY (`dependent_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_406AA1EAD526A7D3` FOREIGN KEY (`parent_user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `invitation_request_custom_field`
--

DROP TABLE IF EXISTS `invitation_request_custom_field`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invitation_request_custom_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platform_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` enum('textarea','textinput','checkbox','select','radio') COLLATE utf8_unicode_ci DEFAULT NULL,
  `options` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `IDX_E22EE713FFE6496F` (`platform_id`),
  CONSTRAINT `FK_E22EE713FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `invitation_request_custom_field`
--

LOCK TABLES `invitation_request_custom_field` WRITE;
/*!40000 ALTER TABLE `invitation_request_custom_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `invitation_request_custom_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invitation_request_custom_value`
--

DROP TABLE IF EXISTS `invitation_request_custom_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invitation_request_custom_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `invitation_request_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `value` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_A66C487DD84F95E8` (`invitation_request_id`),
  KEY `IDX_A66C487DA1E5E0D4` (`custom_field_id`),
  CONSTRAINT `FK_A66C487DA1E5E0D4` FOREIGN KEY (`custom_field_id`) REFERENCES `invitation_request_custom_field` (`id`),
  CONSTRAINT `FK_A66C487DD84F95E8` FOREIGN KEY (`invitation_request_id`) REFERENCES `invitation_request` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `invitation_request_custom_value`
--

LOCK TABLES `invitation_request_custom_value` WRITE;
/*!40000 ALTER TABLE `invitation_request_custom_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `invitation_request_custom_value` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invitation_requests_users`
--

DROP TABLE IF EXISTS `invitation_requests_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invitation_requests_users` (
  `user_id` int(11) NOT NULL,
  `invitation_request_id` int(11) NOT NULL,
...
--
-- Dumping data for table `invitation_requests_users`
--

LOCK TABLES `invitation_requests_users` WRITE;
/*!40000 ALTER TABLE `invitation_requests_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `invitation_requests_users` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `language` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iso_code` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `language` VALUES (7,'es_ES','Español','es'),(8,'en_US','English','en'),(9,'pt_BR','Português','pt');
...
CREATE TABLE `likes` (
  ...
  `subject_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_49CA4E7DF675F31B1E14D3F223EDC87` (`author_id`,`subject_type`,`subject_id`),
  KEY `IDX_49CA4E7DF675F31B` (`author_id`),
  KEY `IDX_49CA4E7DFFE6496F` (`platform_id`),
  KEY `IDX_49CA4E7D23EDC87` (`subject_id`),
  CONSTRAINT `FK_49CA4E7DF675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_49CA4E7DFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `location_ranged_address`
--

DROP TABLE IF EXISTS `location_ranged_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `location_ranged_address` (
  `id` int(11) NOT NULL,
  `address_id` int(11) NOT NULL,
  `radius` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_F719736CF5B7AF75` (`address_id`),
  CONSTRAINT `FK_F719736CBF396750` FOREIGN KEY (`id`) REFERENCES `location` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_F719736CF5B7AF75` FOREIGN KEY (`address_id`) REFERENCES `address` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `location_ranged_address`
--

LOCK TABLES `location_ranged_address` WRITE;
/*!40000 ALTER TABLE `location_ranged_address` DISABLE KEYS */;
/*!40000 ALTER TABLE `location_ranged_address` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mention` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `container_subject_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_E20259CDF675F31B` (`author_id`),
  KEY `IDX_E20259CDFFE6496F` (`platform_id`),
  KEY `IDX_E20259CDBC21F742` (`container_id`),
  KEY `IDX_E20259CD23EDC87` (`subject_id`),
  CONSTRAINT `FK_E20259CD23EDC87` FOREIGN KEY (`subject_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_E20259CDF675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_E20259CDFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migration_versions` VALUES ('20130624113923'),('20130624174322'),('20130625155248'),('20130625210252'),('20130626114038'),('20130626141809'),('20130626154111'),('20130627155855'),('20130628140358'),('20130702124945'),('20130704165918'),('20130711142006'),('20130712144751'),('20130712155852'),('20130715130253'),('20130715162429'),('20130718111449'),('20130718135826'),('20130718202830'),('20130719162943'),('20130729160604'),('20130730111307'),('20130802135024'),('20130802193600'),('20130805123840'),('20130807122703'),('20130808145719'),('20130809113155'),('20130814144532'),('20130814182612'),('20130815163725'),('20130816151018'),('20130821170147'),('20130822161941'),('20130823125000'),('20130826104832'),('20130826151633'),('20130827101934'),('20130827153607'),('20130829232959'),('20130902153029'),('20130903150709'),('20130903185942'),('20130904153057'),('20130905121437'),('20130905194244'),('20130909144139'),('20130910105506'),('20130912143828'),('20130912155258'),('20130912180500'),('20130923181814'),('20130927180800'),('20130930181307'),('20131003172145'),('20131007172712'),('20131009112613'),('20131010105520'),('20131010110606'),('20131015133937'),('20131018180139'),('20131021145449'),('20131024124734'),('20131024140917'),('20131025163204'),('20131030150826'),('20131101165802'),('20131104162540'),('20131106160811'),('20131106163100'),('20131115150645'),('20131115153000'),('20131115171720'),('20131119154506'),('20131120173839'),('20131121131620'),('20131121152956'),('20131122174541'),('20131126113624'),('20131126165714'),('20131127143655'),('20131128110224'),('20131128123943'),('20131128141800'),('20131128163514'),('20131129160304'),('20131202101924'),('20131202154920'),('20131203173349'),('20131203181324'),('20131204154454'),('20131205102804'),('20131206120103'),('20131210200310'),('20131212021217'),('20131213100605'),('20131213133838'),('20131216103054'),('20131217110046'),('20131218094000'),('20131227102831'),('20131230172235'),('20140102163702'),('20140103133452'),('20140106092000'),('20140106092100'),('20140106092200'),('20140106092300'),('20140106092400'),('20140106092500'),('20140106122232'),('20140107125000'),('20140108154914'),('20140110121000'),('20140113153251'),('20140113170041'),('20140114172300'),('20140114172500'),('20140115125956'),('20140122115354'),('20140127170105'),('20140206113445'),('20140206154205'),('20140207182503'),('20140207225632'),('20140210090215'),('20140210122436'),('20140210162915'),('20140211215839'),('20140212154540'),('20140213114206'),('20140213152048'),('20140213200212'),('20140214133622'),('20140214142803'),('20140216125236'),('20140217114637'),('20140217120648'),('20140217120820'),('20140217123839'),('20140217133439'),('20140218143142'),('20140218175258'),('20140219134143'),('20140220112500'),('20140220115321'),('20140220124015'),('20140221100709'),('20140225100200'),('20140228104417'),('20140306150500'),('20140312160704'),('20140314174048'),('20140320145000'),('20140321112326'),('20140321112541'),('20140321112625'),('20140326162000'),('20140327144034'),('20140401120000'),('20140407164206'),('20140415134320'),('20140415162709'),('20140415183258'),('20140422155253'),('20140423122419'),('20140423132410'),('20140423151135'),('20140423151516'),('20140424125617'),('20140424132419'),('20140429115929'),('20140506110406'),('20140513124000'),('20140520122251'),('20140520122351'),('20140520122400'),('20140527152506'),('20140527165454'),('20140527165455'),('20140527165456'),('20140527175103'),('20140528142638'),('20140529140000'),('20140529140001'),('20140529140002'),('20140609121823'),('20140609180000'),('20140616112000'),('20140617123800'),('20140701165536'),('20140701173000'),('20140707123538'),('20140707153644'),('20140707164405'),('20140707183018'),('20140710145500'),('20140710150219'),('20140710161142'),('20140711105857'),('20140711120726'),('20140711141403'),('20140715121655'),('20140716124503'),('20140717172545'),('20140721124000'),('20140721161520'),('20140722175102'),('20140724113510'),('20140725162644'),('20140729110910'),('20140801155000'),('20140801164048'),('20140805122745'),('20140807143751'),('20140812104403'),('20140815180639'),('20140819163652'),('20140819163653'),('20140819163654'),('20140819163655'),('20140820101719'),('20140820105925'),('20140822113701'),('20140827163705'),('20140828112000'),('20140828113805'),('20140828180000'),('20140901180000'),('20140902103700'),('20140902145200'),('20140904113226'),('20140905161242'),('20140908113612'),('20140908145200'),('20140909174949'),('20140915225632'),('20140916171000'),('20140917181621'),('20140919174230'),('20140929160424'),('20140930105453'),('20141001154759'),('20141001163702'),('20141003155524'),('20141006164256'),('20141008121500'),('20141009164423'),('20141016174719'),('20141017175808'),('20141023154823'),('20141028155513'),('20141028171343'),('20141117175232'),('20141119164500'),('20141120113249'),('20141126140724'),('20141201154600'),('20141205124110'),('20141205164553'),('20141210165025'),('20141211100000'),('20141216115307'),('20141217110336'),('20141222104146'),('20150105120837'),('20150113120007'),('20150119115458'),('20150218104118'),('20150226171714'),('20150303132416'),('20150305170310'),('20150306114304'),('20150306170310'),('20150310180258'),('20150319115259'),('20150326162438'),('20150330112120'),('20150331170135'),('20150423174642'),('20150424120749'),('20150427110245'),('20150430114019'),('20150504121809'),('20150504123521'),('20150504164254'),('20150504173337'),('20150506114328'),('20150506120809'),('20150507110741'),('20150507111008'),('20150507121732'),('20150507143646'),('20150507165058'),('20150508153717'),('20150518113734'),('20150529113734'),('20150601124352'),('20150601131355'),('20150603123804'),('20150605151113'),('20150611113734'),('20150611121620'),('20150612155518'),('20150612175120'),('20150615151551'),('20150616150000'),('20150619125201'),('20150619161340'),('20150622123024'),('20150622123146'),('20150626120727'),('20150626120939'),('20150630103011'),('20150630152906'),('20150701103011'),('20150701144715'),('20150703133218'),('20150706105933'),('20150706150314'),('20150708112619'),('20150710150314'),('20150710161340'),('20150715111010'),('20150715121010'),('20150716180637'),('20150720162441'),('20150724110204'),('20150727125004'),('20150727143937'),('20150730160934'),('20150804102112'),('20150805162009'),('20150807151839'),('20150819104808'),('20150819142956'),('20150908160934'),('20150914104933'),('20150917114459'),('20150918124400'),('20150918125321'),('20150928123245'),('20150929162407');
...
CREATE TABLE `news_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `news_app_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sorting` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4F72BA90F52EE259` (`news_app_id`),
  CONSTRAINT `FK_4F72BA90F52EE259` FOREIGN KEY (`news_app_id`) REFERENCES `workspace_application` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `news_content` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `social_enabled` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_A9212C4F7E3C61F9` (`owner_id`),
...
CREATE TABLE `notification` (
  ...
  `event_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_BF5476CA71F7E88B` (`event_id`),
  CONSTRAINT `FK_BF5476CA71F7E88B` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notification_preference` (
  ...
  `post_in_my_wall` tinyint(1) NOT NULL,
  `my_wall_activity` tinyint(1) NOT NULL,
  `contents_activity` tinyint(1) NOT NULL,
  `mention_me` tinyint(1) NOT NULL,
  `users_activity` tinyint(1) NOT NULL,
  `frequency` enum('DAILY','WEEKLY','MONTHLY') COLLATE utf8_unicode_ci DEFAULT NULL,
  `workspace_enabled` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_A61B1571A76ED395` (`user_id`),
  CONSTRAINT `FK_A61B1571A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification_preference` VALUES (8,10,1,1,1,1,1,1,1,'DAILY',0),(9,11,1,1,1,1,1,1,1,'DAILY',0),(10,12,1,1,1,1,1,1,1,'DAILY',0),(11,13,1,1,1,1,1,1,1,'DAILY',0),(12,14,1,1,1,1,1,1,1,'DAILY',0),(13,15,1,1,1,1,1,1,1,'DAILY',0),(14,16,1,1,1,1,1,1,1,'DAILY',0);
...
INSERT INTO `oauth_access_token` VALUES (2,10,2,'access_token',1735704000,NULL);
...
INSERT INTO `oauth_client` VALUES (2,'jhonconnor','random_id','a:0:{}','secret','a:4:{i:0;s:20:\"http://gointegro.com\";i:1;s:13:\"refresh_token\";i:2;s:8:\"password\";i:3;s:5:\"token\";}');
...
CREATE TABLE `platform` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `image_max_size` bigint(20) DEFAULT NULL,
  `storage` bigint(20) DEFAULT NULL,
  `timezone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `disable` tinyint(1) DEFAULT NULL,
  `google_analytics_tracking` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `signin_protocol` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `host` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `host_alias` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `social_enabled` tinyint(1) NOT NULL,
  `signin_banner_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `logo_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `logo_url_footer` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `unique_field` enum('usernameId','document','email') COLLATE utf8_unicode_ci DEFAULT NULL,
  `show_user_email` tinyint(1) DEFAULT NULL,
  `video_max_size` smallint(6) DEFAULT NULL,
  `industry_id` int(11) DEFAULT NULL,
  `users_range_id` int(11) DEFAULT NULL,
  `mobile_activation_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `target_user_type_id` int(11) NOT NULL,
  `benefits_enabled` tinyint(1) NOT NULL,
  `uses_benefits_card` tinyint(1) NOT NULL,
  `logo_benefits_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `benefit_header_title` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_visibility` enum('VISIBLE','HIDDEN') COLLATE utf8_unicode_ci DEFAULT NULL,
  `benefits_public` tinyint(1) NOT NULL,
  `dependent_user` tinyint(1) NOT NULL,
  `social_notifications_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `areas_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `usergroup_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `hierarchy_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `uses_coupon` tinyint(1) NOT NULL,
  `demo` tinyint(1) NOT NULL DEFAULT '0',
  `implemented` tinyint(1) NOT NULL DEFAULT '0',
  `implemented_date` date DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `rewards_enabled` tinyint(1) NOT NULL,
  `rewards_client_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rewards_client_secret` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rewards_account_id` int(11) DEFAULT NULL,
  `show_user_phone` tinyint(1) DEFAULT NULL,
  `show_user_cellphone` tinyint(1) DEFAULT NULL,
  `show_user_position` tinyint(1) DEFAULT NULL,
  `show_user_chief` tinyint(1) DEFAULT NULL,
  `show_user_department` tinyint(1) DEFAULT NULL,
  `show_user_area` tinyint(1) DEFAULT NULL,
  `show_user_location` tinyint(1) DEFAULT NULL,
  `social_notification_time` int(11) DEFAULT '0',
  `recognition_enabled` tinyint(1) NOT NULL,
  `recognition_account_id` int(11) DEFAULT NULL,
  `recognition_client_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `recognition_client_secret` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_3952D0CBCF2713FD` (`host`),
  UNIQUE KEY `UNIQ_3952D0CB420E2667` (`host_alias`),
  UNIQUE KEY `UNIQ_3952D0CB70455DA8` (`mobile_activation_code`),
  UNIQUE KEY `UNIQ_3952D0CB97314E71` (`rewards_client_id`),
  UNIQUE KEY `UNIQ_3952D0CB8EDC7F23` (`rewards_client_secret`),
  UNIQUE KEY `UNIQ_3952D0CBF08ED469` (`rewards_account_id`),
  UNIQUE KEY `UNIQ_3952D0CB2E19520C` (`recognition_account_id`),
  KEY `IDX_3952D0CB9B6B5FBA` (`account_id`),
  KEY `IDX_3952D0CB248673E9` (`default_role_id`),
  KEY `IDX_3952D0CB5602A942` (`default_language_id`),
  KEY `IDX_3952D0CB2B19A734` (`industry_id`),
  KEY `IDX_3952D0CB41CD9E7A` (`users_range_id`),
  KEY `IDX_3952D0CB6C066AFE` (`target_user_type_id`),
  CONSTRAINT `FK_3952D0CB248673E9` FOREIGN KEY (`default_role_id`) REFERENCES `role` (`id`),
  CONSTRAINT `FK_3952D0CB2B19A734` FOREIGN KEY (`industry_id`) REFERENCES `platform_industry` (`id`),
  CONSTRAINT `FK_3952D0CB41CD9E7A` FOREIGN KEY (`users_range_id`) REFERENCES `platform_users_range` (`id`),
  CONSTRAINT `FK_3952D0CB5602A942` FOREIGN KEY (`default_language_id`) REFERENCES `language` (`id`),
  CONSTRAINT `FK_3952D0CB6C066AFE` FOREIGN KEY (`target_user_type_id`) REFERENCES `target_user_type` (`id`),
  CONSTRAINT `FK_3952D0CB9B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `platform_address` (
  ...
  `address_aditional` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `locality` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `province` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_187EA5D3FFE6496F` (`platform_id`),
  KEY `IDX_187EA5D3F92F3E70` (`country_id`),
  CONSTRAINT `FK_187EA5D3F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`),
  CONSTRAINT `FK_187EA5D3FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
...
INSERT INTO `platform_address` VALUES (7,3,'Dirección 1',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400'),(8,3,'Dirección 2',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400'),(9,3,'Dirección 3',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400'),(10,3,'Dirección 4',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400'),(11,3,'Dirección 5',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400'),(12,3,'Dirección 6',1,'C1427CCO',26,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','+54 11 5353-6400');
/*!40000 ALTER TABLE `platform_address` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `platform_application_bkp`
--

DROP TABLE IF EXISTS `platform_application_bkp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `platform_application_bkp` (
  `platform_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL,
  PRIMARY KEY (`platform_id`,`application_id`),
  KEY `IDX_EBFCDB66FFE6496F` (`platform_id`),
  KEY `IDX_EBFCDB663E030ACD` (`application_id`),
  CONSTRAINT `FK_EBFCDB663E030ACD` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_EBFCDB66FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `platform_application_bkp`
--

LOCK TABLES `platform_application_bkp` WRITE;
/*!40000 ALTER TABLE `platform_application_bkp` DISABLE KEYS */;
/*!40000 ALTER TABLE `platform_application_bkp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `platform_country`
--

DROP TABLE IF EXISTS `platform_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `platform_country` (
  `platform_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  PRIMARY KEY (`platform_id`,`country_id`),
  KEY `IDX_46430334FFE6496F` (`platform_id`),
  KEY `IDX_46430334F92F3E70` (`country_id`),
  CONSTRAINT `FK_46430334F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_46430334FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `platform_country`
--

LOCK TABLES `platform_country` WRITE;
/*!40000 ALTER TABLE `platform_country` DISABLE KEYS */;
INSERT INTO `platform_country` VALUES (3,26);
/*!40000 ALTER TABLE `platform_country` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `platform_industry`
--

DROP TABLE IF EXISTS `platform_industry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `platform_industry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `platform_industry`
--

LOCK TABLES `platform_industry` WRITE;
/*!40000 ALTER TABLE `platform_industry` DISABLE KEYS */;
INSERT INTO `platform_industry` VALUES (48,'Bodegas'),(49,'Informática'),(50,'Combustible'),(51,'Restaurante');
/*!40000 ALTER TABLE `platform_industry` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `platform_language`
--

DROP TABLE IF EXISTS `platform_language`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `platform_language` (
  `platform_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  PRIMARY KEY (`platform_id`,`language_id`),
  KEY `IDX_51AB71A7FFE6496F` (`platform_id`),
  KEY `IDX_51AB71A782F1BAF4` (`language_id`),
  CONSTRAINT `FK_51AB71A782F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_51AB71A7FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `platform_language`
--

LOCK TABLES `platform_language` WRITE;
/*!40000 ALTER TABLE `platform_language` DISABLE KEYS */;
INSERT INTO `platform_language` VALUES (3,7),(3,8),(3,9);
/*!40000 ALTER TABLE `platform_language` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `platform_role` (
  `platform_id` int(11) NOT NULL,
  `role_id` int(11) NOT NULL,
  PRIMARY KEY (`platform_id`,`role_id`),
  KEY `IDX_D361ED46FFE6496F` (`platform_id`),
  KEY `IDX_D361ED46D60322AC` (`role_id`),
  CONSTRAINT `FK_D361ED46D60322AC` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_D361ED46FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `platform_role` VALUES (3,7),(3,8),(3,9);
/*!40000 ALTER TABLE `platform_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `platform_users_range`
--

DROP TABLE IF EXISTS `platform_users_range`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `platform_users_range` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `platform_users_range`
--

LOCK TABLES `platform_users_range` WRITE;
/*!40000 ALTER TABLE `platform_users_range` DISABLE KEYS */;
INSERT INTO `platform_users_range` VALUES (13,'0-100'),(14,'100-150'),(15,'150-200'),(16,'200-300');
/*!40000 ALTER TABLE `platform_users_range` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `post` (
  ...
  `subject_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_5A8A6C8D93CB796C` (`file_id`),
  KEY `IDX_5A8A6C8DF675F31B` (`author_id`),
  KEY `IDX_5A8A6C8DFFE6496F` (`platform_id`),
  KEY `IDX_5A8A6C8D23EDC87` (`subject_id`),
  CONSTRAINT `FK_5A8A6C8D93CB796C` FOREIGN KEY (`file_id`) REFERENCES `file` (`id`),
  CONSTRAINT `FK_5A8A6C8DF675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_5A8A6C8DFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `public_file`
--
...
--
-- Dumping data for table `public_file`
--

LOCK TABLES `public_file` WRITE;
/*!40000 ALTER TABLE `public_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `public_file` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `recipient_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_39ED9F7EEF1A9D84` (`notification_id`),
  KEY `IDX_39ED9F7EE284468` (`entity`),
  KEY `IDX_39ED9F7E82D40A1F` (`workspace_id`),
  CONSTRAINT `FK_39ED9F7E82D40A1F` FOREIGN KEY (`workspace_id`) REFERENCES `workspace` (`id`),
  CONSTRAINT `FK_39ED9F7EEF1A9D84` FOREIGN KEY (`notification_id`) REFERENCES `notification` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `recipient_group` WRITE;
/*!40000 ALTER TABLE `recipient_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `recipient_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recognitions_export_job`
--

DROP TABLE IF EXISTS `recognitions_export_job`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recognitions_export_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `program_id` int(11) NOT NULL,
  `status` enum('pending','done','processing','error') COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` enum('recognitions','nominations','approvals','admin') COLLATE utf8_unicode_ci DEFAULT NULL,
  `file` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `error` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_CF19A57DA76ED395` (`user_id`),
  KEY `IDX_CF19A57D3EB8070A` (`program_id`),
  CONSTRAINT `FK_CF19A57D3EB8070A` FOREIGN KEY (`program_id`) REFERENCES `recognitions_recognition_program` (`id`),
  CONSTRAINT `FK_CF19A57DA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recognitions_export_job`
--

LOCK TABLES `recognitions_export_job` WRITE;
/*!40000 ALTER TABLE `recognitions_export_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `recognitions_export_job` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recognitions_notification`
--

DROP TABLE IF EXISTS `recognitions_notification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recognitions_notification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `program_id` int(11) NOT NULL,
  `recognition_reference_id` int(11) NOT NULL,
  `status` enum('pending','done','error','processing') COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` enum('done','pending','approved','rejected') COLLATE utf8_unicode_ci DEFAULT NULL,
  `notified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_737AB63B3EB8070A` (`program_id`),
  CONSTRAINT `FK_737AB63B3EB8070A` FOREIGN KEY (`program_id`) REFERENCES `recognitions_recognition_program` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recognitions_notification`
--

LOCK TABLES `recognitions_notification` WRITE;
/*!40000 ALTER TABLE `recognitions_notification` DISABLE KEYS */;
/*!40000 ALTER TABLE `recognitions_notification` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recognitions_recognition`
--

DROP TABLE IF EXISTS `recognitions_recognition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recognitions_recognition` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `recognition_program_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_2E8CEFB396048D1E` (`nominator_id`),
  KEY `IDX_2E8CEFB3C6A2398` (`nominee_id`),
  KEY `IDX_2E8CEFB3BB23766C` (`approver_id`),
  KEY `IDX_2E8CEFB38BCA0ABC` (`recognition_program_id`),
  CONSTRAINT `FK_2E8CEFB38BCA0ABC` FOREIGN KEY (`recognition_program_id`) REFERENCES `recognitions_recognition_program` (`id`),
  CONSTRAINT `FK_2E8CEFB396048D1E` FOREIGN KEY (`nominator_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_2E8CEFB3BB23766C` FOREIGN KEY (`approver_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_2E8CEFB3C6A2398` FOREIGN KEY (`nominee_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recognitions_recognition`
--

LOCK TABLES `recognitions_recognition` WRITE;
/*!40000 ALTER TABLE `recognitions_recognition` DISABLE KEYS */;
/*!40000 ALTER TABLE `recognitions_recognition` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recognitions_recognition_program`
--

DROP TABLE IF EXISTS `recognitions_recognition_program`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `recognitions_recognition_program` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `approver_group_id` int(11) DEFAULT NULL,
  `approver_user_id` int(11) DEFAULT NULL,
  `nominator_group_id` int(11) DEFAULT NULL,
  `nominator_user_id` int(11) DEFAULT NULL,
  `nominee_group_id` int(11) DEFAULT NULL,
  `catalog_account_id` int(11) DEFAULT NULL,
  `approverHierarchical` tinyint(1) NOT NULL,
  `approver_notifications` tinyint(1) NOT NULL,
  `nominator_notifications` tinyint(1) NOT NULL,
  `nominee_notifications` tinyint(1) NOT NULL,
  `referenceId` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `platform_id` int(11) NOT NULL,
  `nominator_hierarchical` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_5CB7D485E8C1BF84` (`approver_group_id`),
  KEY `IDX_5CB7D4855EC7554A` (`approver_user_id`),
  KEY `IDX_5CB7D4859CBF3036` (`nominator_group_id`),
  KEY `IDX_5CB7D485919A7DC9` (`nominator_user_id`),
  KEY `IDX_5CB7D485B03C5B12` (`nominee_group_id`),
  KEY `IDX_5CB7D4852E41AD61` (`catalog_account_id`),
  KEY `IDX_5CB7D485FFE6496F` (`platform_id`),
  CONSTRAINT `FK_5CB7D4852E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `rewards_catalog_account` (`id`),
  CONSTRAINT `FK_5CB7D4855EC7554A` FOREIGN KEY (`approver_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_5CB7D485919A7DC9` FOREIGN KEY (`nominator_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_5CB7D4859CBF3036` FOREIGN KEY (`nominator_group_id`) REFERENCES `user_group` (`id`),
  CONSTRAINT `FK_5CB7D485B03C5B12` FOREIGN KEY (`nominee_group_id`) REFERENCES `user_group` (`id`),
  CONSTRAINT `FK_5CB7D485E8C1BF84` FOREIGN KEY (`approver_group_id`) REFERENCES `user_group` (`id`),
  CONSTRAINT `FK_5CB7D485FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recognitions_recognition_program`
--

LOCK TABLES `recognitions_recognition_program` WRITE;
/*!40000 ALTER TABLE `recognitions_recognition_program` DISABLE KEYS */;
/*!40000 ALTER TABLE `recognitions_recognition_program` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `resolution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_FDD30F8AFDD30F8A` (`resolution`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `resolution` VALUES (5,360),(6,720);
/*!40000 ALTER TABLE `resolution` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reward_redeem_export_job`
--

DROP TABLE IF EXISTS `reward_redeem_export_job`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_redeem_export_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `status` enum('pending','done','error','processing') COLLATE utf8_unicode_ci DEFAULT NULL,
  `file` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `custom_configuration` longtext COLLATE utf8_unicode_ci,
  `catalog_account_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_DBB112ECA76ED395` (`user_id`),
  KEY `IDX_DBB112EC2E41AD61` (`catalog_account_id`),
  CONSTRAINT `FK_DBB112EC2E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `rewards_catalog_account` (`id`),
  CONSTRAINT `FK_DBB112ECA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_redeem_export_job`
--

LOCK TABLES `reward_redeem_export_job` WRITE;
/*!40000 ALTER TABLE `reward_redeem_export_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `reward_redeem_export_job` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rewards_catalog_account`
--

DROP TABLE IF EXISTS `rewards_catalog_account`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rewards_catalog_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platform_id` int(11) NOT NULL,
  `default_address_id` int(11) DEFAULT NULL,
  `reference_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `autojoin` tinyint(1) NOT NULL,
  `checkout_information_header` longtext COLLATE utf8_unicode_ci,
  `checkout_information_footer` longtext COLLATE utf8_unicode_ci,
  `delivery_address_type` enum('default','platform','user') COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_admin_approver_id` int(11) DEFAULT NULL,
  `user_group_approver_id` int(11) DEFAULT NULL,
  `user_admin_approval` tinyint(1) NOT NULL,
  `user_group_approval` tinyint(1) NOT NULL,
  `hierarchical_approval` tinyint(1) NOT NULL,
  `notify_approvers` tinyint(1) NOT NULL,
  `reward_notifications` tinyint(1) NOT NULL,
  `final_message_transaction` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `IDX_AFA93F1CFFE6496F` (`platform_id`),
  KEY `IDX_AFA93F1CBD94FB16` (`default_address_id`),
  KEY `IDX_AFA93F1CDE26844E` (`user_admin_approver_id`),
  KEY `IDX_AFA93F1C6684D286` (`user_group_approver_id`),
  CONSTRAINT `FK_AFA93F1C6684D286` FOREIGN KEY (`user_group_approver_id`) REFERENCES `user_group` (`id`),
  CONSTRAINT `FK_AFA93F1CBD94FB16` FOREIGN KEY (`default_address_id`) REFERENCES `platform_address` (`id`),
  CONSTRAINT `FK_AFA93F1CDE26844E` FOREIGN KEY (`user_admin_approver_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_AFA93F1CFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rewards_catalog_account`
--

LOCK TABLES `rewards_catalog_account` WRITE;
/*!40000 ALTER TABLE `rewards_catalog_account` DISABLE KEYS */;
/*!40000 ALTER TABLE `rewards_catalog_account` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rewards_catalog_account_user_group`
--

DROP TABLE IF EXISTS `rewards_catalog_account_user_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rewards_catalog_account_user_group` (
  `catalog_account_id` int(11) NOT NULL,
  `user_group_id` int(11) NOT NULL,
  PRIMARY KEY (`catalog_account_id`,`user_group_id`),
  KEY `IDX_EA3701CB2E41AD61` (`catalog_account_id`),
  KEY `IDX_EA3701CB1ED93D47` (`user_group_id`),
  CONSTRAINT `FK_EA3701CB1ED93D47` FOREIGN KEY (`user_group_id`) REFERENCES `user_group` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_EA3701CB2E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `rewards_catalog_account` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rewards_catalog_account_user_group`
--

LOCK TABLES `rewards_catalog_account_user_group` WRITE;
/*!40000 ALTER TABLE `rewards_catalog_account_user_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `rewards_catalog_account_user_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rewards_redeem`
--

DROP TABLE IF EXISTS `rewards_redeem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rewards_redeem` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `catalog_account_id` int(11) NOT NULL,
  `reference_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_CA7673AEA76ED395` (`user_id`),
  KEY `IDX_CA7673AE2E41AD61` (`catalog_account_id`),
  CONSTRAINT `FK_CA7673AE2E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `rewards_catalog_account` (`id`),
  CONSTRAINT `FK_CA7673AEA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rewards_redeem`
--

LOCK TABLES `rewards_redeem` WRITE;
/*!40000 ALTER TABLE `rewards_redeem` DISABLE KEYS */;
/*!40000 ALTER TABLE `rewards_redeem` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rewards_redeem_notification`
--

DROP TABLE IF EXISTS `rewards_redeem_notification`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rewards_redeem_notification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catalog_account_id` int(11) NOT NULL,
  `redeem_reference_id` int(11) NOT NULL,
  `status` enum('pending','done','error','processing') COLLATE utf8_unicode_ci DEFAULT NULL,
  `notified` datetime DEFAULT NULL,
  `type` enum('redeem','approval','purchase') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_262323ED2E41AD61` (`catalog_account_id`),
  CONSTRAINT `FK_262323ED2E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `rewards_catalog_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rewards_redeem_notification`
--

LOCK TABLES `rewards_redeem_notification` WRITE;
/*!40000 ALTER TABLE `rewards_redeem_notification` DISABLE KEYS */;
/*!40000 ALTER TABLE `rewards_redeem_notification` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `role` (
  ...
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_57698A6AFFE6496F` (`platform_id`),
  KEY `IDX_57698A6A727ACA70` (`parent_id`),
  CONSTRAINT `FK_57698A6A727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `role` (`id`),
  CONSTRAINT `FK_57698A6AFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role` VALUES (7,NULL,NULL,'ROLE_ADMIN','system'),(8,7,NULL,'ROLE_ADVANCED','system'),(9,8,NULL,'ROLE_BASIC','system');
...
CREATE TABLE `role_access` (
  ...
  KEY `IDX_AD4FCAE5D60322AC` (`role_id`),
  KEY `IDX_AD4FCAE54FEA67CF` (`access_id`),
  CONSTRAINT `FK_AD4FCAE54FEA67CF` FOREIGN KEY (`access_id`) REFERENCES `access` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_AD4FCAE5D60322AC` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `share` (
  ...
  `updated_at` datetime NOT NULL,
  `subject_id` int(11) NOT NULL,
  `target_subject_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_EF069D5AF675F31B` (`author_id`),
  KEY `IDX_EF069D5AFFE6496F` (`platform_id`),
  KEY `IDX_EF069D5A158E0B66` (`target_id`),
  KEY `IDX_EF069D5A23EDC87` (`subject_id`),
  CONSTRAINT `FK_EF069D5AF675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_EF069D5AFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `signup_configuration`
--

DROP TABLE IF EXISTS `signup_configuration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `signup_configuration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) DEFAULT NULL,
  `platform_id` int(11) DEFAULT NULL,
  `uses_gender` tinyint(1) NOT NULL DEFAULT '0',
  `uses_birth_date` tinyint(1) NOT NULL DEFAULT '0',
  `uses_card` tinyint(1) NOT NULL DEFAULT '0',
  `is_nominated` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_963FCFAF9B6B5FBA` (`account_id`),
  UNIQUE KEY `UNIQ_963FCFAFFFE6496F` (`platform_id`),
  UNIQUE KEY `strategy_unique` (`account_id`,`platform_id`),
  CONSTRAINT `FK_963FCFAF9B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_963FCFAFFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `signup_configuration`
--

LOCK TABLES `signup_configuration` WRITE;
/*!40000 ALTER TABLE `signup_configuration` DISABLE KEYS */;
INSERT INTO `signup_configuration` VALUES (2,NULL,3,0,0,0,0);
/*!40000 ALTER TABLE `signup_configuration` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sso` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `auth_strategy_id` int(11) DEFAULT NULL,
  `unique_field` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_70E959E719D8ABAA` (`auth_strategy_id`),
  CONSTRAINT `FK_70E959E719D8ABAA` FOREIGN KEY (`auth_strategy_id`) REFERENCES `auth_strategy` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `sso_saml2_idp`
--

DROP TABLE IF EXISTS `sso_saml2_idp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sso_saml2_idp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `saml2_id` int(11) DEFAULT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_CE88DCE441B6A48B` (`saml2_id`),
  CONSTRAINT `FK_CE88DCE441B6A48B` FOREIGN KEY (`saml2_id`) REFERENCES `sso` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sso_saml2_idp`
--

LOCK TABLES `sso_saml2_idp` WRITE;
/*!40000 ALTER TABLE `sso_saml2_idp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sso_saml2_idp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sso_saml2_sp`
--

DROP TABLE IF EXISTS `sso_saml2_sp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sso_saml2_sp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `saml2_id` int(11) DEFAULT NULL,
  `source_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_4CA5258741B6A48B` (`saml2_id`),
  CONSTRAINT `FK_4CA5258741B6A48B` FOREIGN KEY (`saml2_id`) REFERENCES `sso` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sso_saml2_sp`
--

LOCK TABLES `sso_saml2_sp` WRITE;
/*!40000 ALTER TABLE `sso_saml2_sp` DISABLE KEYS */;
/*!40000 ALTER TABLE `sso_saml2_sp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `subscribed_application`
--

DROP TABLE IF EXISTS `subscribed_application`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `subscribed_application` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `application_id` int(11) NOT NULL,
  `platform_id` int(11) DEFAULT NULL,
  `application_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `subscribed_application`
--

LOCK TABLES `subscribed_application` WRITE;
/*!40000 ALTER TABLE `subscribed_application` DISABLE KEYS */;
INSERT INTO `subscribed_application` VALUES (10,23,3,'articles'),(11,25,3,'galleries'),(12,26,3,'activityStream'),(13,27,3,'celebrations'),(14,28,3,'tournaments'),(15,24,3,'news'),(16,30,3,'benefitsCategoryMap'),(17,29,3,'benefitsFilter'),(18,31,3,'catalogs');
/*!40000 ALTER TABLE `subscribed_application` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tag` (
  ...
  `author_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_389B7835E237E06FFE6496F` (`name`,`platform_id`),
  KEY `IDX_389B783FFE6496F` (`platform_id`),
  KEY `IDX_389B783F675F31B` (`author_id`),
  CONSTRAINT `FK_389B783F675F31B` FOREIGN KEY (`author_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_389B783FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `target_user_type`
--

DROP TABLE IF EXISTS `target_user_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `target_user_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Dumping data for table `target_user_type`
--

LOCK TABLES `target_user_type` WRITE;
/*!40000 ALTER TABLE `target_user_type` DISABLE KEYS */;
INSERT INTO `target_user_type` VALUES (5,'Empleados'),(6,'Clientes');
/*!40000 ALTER TABLE `target_user_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_configuration`
--

DROP TABLE IF EXISTS `tournaments_configuration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_configuration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `tournaments_configuration`
--

LOCK TABLES `tournaments_configuration` WRITE;
/*!40000 ALTER TABLE `tournaments_configuration` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_configuration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_group`
--

DROP TABLE IF EXISTS `tournaments_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stage_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_stage_group` (`name`,`stage_id`),
  KEY `IDX_8B4F05E12298D193` (`stage_id`),
  CONSTRAINT `FK_8B4F05E12298D193` FOREIGN KEY (`stage_id`) REFERENCES `tournaments_stage` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_group`
--

LOCK TABLES `tournaments_group` WRITE;
/*!40000 ALTER TABLE `tournaments_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_group_translations`
--

DROP TABLE IF EXISTS `tournaments_group_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_group_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_2C15F62D232D562B` (`object_id`),
  CONSTRAINT `FK_2C15F62D232D562B` FOREIGN KEY (`object_id`) REFERENCES `tournaments_group` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_group_translations`
--

LOCK TABLES `tournaments_group_translations` WRITE;
/*!40000 ALTER TABLE `tournaments_group_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_group_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_match`
--

DROP TABLE IF EXISTS `tournaments_match`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_match` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stage_id` int(11) NOT NULL,
  `group_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `tournaments_match`
--

LOCK TABLES `tournaments_match` WRITE;
/*!40000 ALTER TABLE `tournaments_match` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_match` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_match_team_score`
--

DROP TABLE IF EXISTS `tournaments_match_team_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_match_team_score` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `tournaments_match_team_score`
--

LOCK TABLES `tournaments_match_team_score` WRITE;
/*!40000 ALTER TABLE `tournaments_match_team_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_match_team_score` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_platform_tournament`
--

DROP TABLE IF EXISTS `tournaments_platform_tournament`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_platform_tournament` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tournament_id` int(11) DEFAULT NULL,
  `platform_application_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `tournaments_platform_tournament`
--

LOCK TABLES `tournaments_platform_tournament` WRITE;
/*!40000 ALTER TABLE `tournaments_platform_tournament` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_platform_tournament` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_stage`
--

DROP TABLE IF EXISTS `tournaments_stage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_stage` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `exact_result_points` int(11) NOT NULL,
  `result_points` int(11) NOT NULL,
  `sorting` int(11) NOT NULL,
  `is_default` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_24F3D24D33D1A3E7` (`tournament_id`),
  CONSTRAINT `FK_24F3D24D33D1A3E7` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments_tournament` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_stage`
--

LOCK TABLES `tournaments_stage` WRITE;
/*!40000 ALTER TABLE `tournaments_stage` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_stage` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_stage_translations`
--

DROP TABLE IF EXISTS `tournaments_stage_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_stage_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_805D404F232D562B` (`object_id`),
  CONSTRAINT `FK_805D404F232D562B` FOREIGN KEY (`object_id`) REFERENCES `tournaments_stage` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_stage_translations`
--

LOCK TABLES `tournaments_stage_translations` WRITE;
/*!40000 ALTER TABLE `tournaments_stage_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_stage_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_subscribed_application_tournament`
--

DROP TABLE IF EXISTS `tournaments_subscribed_application_tournament`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_subscribed_application_tournament` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tournaments_subscribed_application_id` int(11) DEFAULT NULL,
  `tournament_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `tournaments_subscribed_application_tournament`
--

LOCK TABLES `tournaments_subscribed_application_tournament` WRITE;
/*!40000 ALTER TABLE `tournaments_subscribed_application_tournament` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_subscribed_application_tournament` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_team`
--

DROP TABLE IF EXISTS `tournaments_team`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_team` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_tournament_team` (`name`,`tournament_id`),
  KEY `IDX_28FD835033D1A3E7` (`tournament_id`),
  CONSTRAINT `FK_28FD835033D1A3E7` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments_tournament` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_team`
--

LOCK TABLES `tournaments_team` WRITE;
/*!40000 ALTER TABLE `tournaments_team` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_team` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_team_translations`
--

DROP TABLE IF EXISTS `tournaments_team_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_team_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_9CE25B00232D562B` (`object_id`),
  CONSTRAINT `FK_9CE25B00232D562B` FOREIGN KEY (`object_id`) REFERENCES `tournaments_team` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_team_translations`
--

LOCK TABLES `tournaments_team_translations` WRITE;
/*!40000 ALTER TABLE `tournaments_team_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_team_translations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tournaments_tournament` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `forecastDescription` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `fixtureDescription` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `rankingDescription` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL,
  `firstPoints` int(11) DEFAULT NULL,
  `secondPoints` int(11) DEFAULT NULL,
  `thirdPoints` int(11) DEFAULT NULL,
  `finished` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_48FB069273F32DD8` (`configuration_id`),
  CONSTRAINT `FK_48FB069273F32DD8` FOREIGN KEY (`configuration_id`) REFERENCES `tournaments_configuration` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tournaments_tournament_translations`
--

DROP TABLE IF EXISTS `tournaments_tournament_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_tournament_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_206F8C34232D562B` (`object_id`),
  CONSTRAINT `FK_206F8C34232D562B` FOREIGN KEY (`object_id`) REFERENCES `tournaments_tournament` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_tournament_translations`
--

LOCK TABLES `tournaments_tournament_translations` WRITE;
/*!40000 ALTER TABLE `tournaments_tournament_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_tournament_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_user_score`
--

DROP TABLE IF EXISTS `tournaments_user_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_user_score` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_25FF7242A76ED395` (`user_id`),
  KEY `IDX_25FF72423E030ACD` (`application_id`),
  CONSTRAINT `FK_25FF72423E030ACD` FOREIGN KEY (`application_id`) REFERENCES `workspace_application` (`id`),
  CONSTRAINT `FK_25FF7242A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_user_score`
--

LOCK TABLES `tournaments_user_score` WRITE;
/*!40000 ALTER TABLE `tournaments_user_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_user_score` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_user_score_prediction`
--

DROP TABLE IF EXISTS `tournaments_user_score_prediction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_user_score_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `team_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `match_id` int(11) NOT NULL,
  ...
  `score` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_match_score_prediction` (`match_id`,`team_id`,`user_id`,`application_id`),
  KEY `IDX_D1330A42296CD8AE` (`team_id`),
...
--
-- Dumping data for table `tournaments_user_score_prediction`
--

LOCK TABLES `tournaments_user_score_prediction` WRITE;
/*!40000 ALTER TABLE `tournaments_user_score_prediction` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_user_score_prediction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_user_winner_prediction`
--

DROP TABLE IF EXISTS `tournaments_user_winner_prediction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_user_winner_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `team_id` int(11) NOT NULL,
  `application_id` int(11) NOT NULL,
...
--
-- Dumping data for table `tournaments_user_winner_prediction`
--

LOCK TABLES `tournaments_user_winner_prediction` WRITE;
/*!40000 ALTER TABLE `tournaments_user_winner_prediction` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_user_winner_prediction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tournaments_winner`
--

DROP TABLE IF EXISTS `tournaments_winner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tournaments_winner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tournament_id` int(11) NOT NULL,
  `team_id` int(11) NOT NULL,
  `ranking` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_30130B9E33D1A3E7` (`tournament_id`),
  KEY `IDX_30130B9E296CD8AE` (`team_id`),
  CONSTRAINT `FK_30130B9E296CD8AE` FOREIGN KEY (`team_id`) REFERENCES `tournaments_team` (`id`),
  CONSTRAINT `FK_30130B9E33D1A3E7` FOREIGN KEY (`tournament_id`) REFERENCES `tournaments_tournament` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournaments_winner`
--

LOCK TABLES `tournaments_winner` WRITE;
/*!40000 ALTER TABLE `tournaments_winner` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournaments_winner` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `translation` (
  ...
  `account_id` int(11) DEFAULT NULL,
  `platform_id` int(11) DEFAULT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'system',
  PRIMARY KEY (`id`),
  KEY `IDX_B469456F82F1BAF4` (`language_id`),
  KEY `IDX_B469456FD145533` (`key_id`),
  KEY `IDX_B469456F9B6B5FBA` (`account_id`),
  KEY `IDX_B469456FFFE6496F` (`platform_id`),
...
--
-- Table structure for table `translations_key`
--

DROP TABLE IF EXISTS `translations_key`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `translations_key` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source_type` enum('js','yml') COLLATE utf8_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `translations_key`
--

LOCK TABLES `translations_key` WRITE;
/*!40000 ALTER TABLE `translations_key` DISABLE KEYS */;
/*!40000 ALTER TABLE `translations_key` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `translations_worker_flag`
--

DROP TABLE IF EXISTS `translations_worker_flag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `translations_worker_flag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Dumping data for table `translations_worker_flag`
--

LOCK TABLES `translations_worker_flag` WRITE;
/*!40000 ALTER TABLE `translations_worker_flag` DISABLE KEYS */;
/*!40000 ALTER TABLE `translations_worker_flag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user` (
  ...
  `signin_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `recover_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `login_attempts` smallint(6) DEFAULT NULL,
  `login_attempt_at` datetime DEFAULT NULL,
  `locked_at` datetime DEFAULT NULL,
  `email_fail_status` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_8D93D649FFE6496F` (`platform_id`),
  KEY `index_document` (`document`),
  KEY `index_email` (`email`),
  KEY `index_username_id` (`username_id`),
  KEY `IDX_8D93D649BD0F409C` (`area_id`),
  KEY `IDX_8D93D649AE80F5DF` (`department_id`),
  KEY `IDX_8D93D6497A7B68E1` (`chief_id`),
  CONSTRAINT `FK_8D93D6497A7B68E1` FOREIGN KEY (`chief_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_8D93D649AE80F5DF` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`),
  CONSTRAINT `FK_8D93D649BD0F409C` FOREIGN KEY (`area_id`) REFERENCES `area` (`id`),
  CONSTRAINT `FK_8D93D649FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_address` (
  ...
  KEY `IDX_5543718BF92F3E70` (`country_id`),
  CONSTRAINT `FK_5543718BA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_5543718BF92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
...
INSERT INTO `user_address` VALUES (25,13,26,'Dirección oficina 1',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(26,13,26,'Dirección oficina 2',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(27,13,26,'Dirección oficina 3',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(28,13,26,'Dirección oficina 4',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(29,13,26,'Dirección oficina 5',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(30,13,26,'Dirección oficina 6',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(31,13,26,'Dirección oficina 7',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(32,13,26,'Dirección oficina 8',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(33,13,26,'Dirección oficina 9',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(34,13,26,'Dirección oficina 10',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(35,13,26,'Dirección oficina 11',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(36,13,26,'Dirección oficina 12',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(37,13,26,'Dirección oficina 13',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(38,13,26,'Dirección oficina 14',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(39,13,26,'Dirección oficina 15',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(40,13,26,'Dirección oficina 16',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(41,13,26,'Dirección oficina 17',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(42,13,26,'Dirección oficina 18',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(43,13,26,'Dirección oficina 19',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(44,13,26,'Dirección oficina 20',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(45,13,26,'Dirección oficina 21',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(46,13,26,'Dirección oficina 22',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(47,13,26,'Dirección oficina 23',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400'),(48,13,26,'Dirección oficina 24',1,'Av. Alvarez Thomas 198, 6º','De 9 a 18 hs','Ciudad Autónoma de Buenos Aires','Ciudad Autónoma de Buenos Aires','C1427CCO','+54 11 5353-6400');
...
CREATE TABLE `user_group` (
  ...
  `root` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_8F02BF9DFFE6496F` (`platform_id`),
  KEY `IDX_8F02BF9D727ACA70` (`parent_id`),
  CONSTRAINT `FK_8F02BF9D727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `user_group` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_8F02BF9DFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
...
INSERT INTO `user_group` VALUES (6,3,'Grupo de usuarios',1,NULL,1,0,8,6),(7,3,'Gerentes',1,6,2,1,3,6),(8,3,'Administrativos',1,6,4,1,5,6),(9,3,'Recursos humanos',1,6,6,1,7,6),(10,3,'Grupo de usuarios inactivo',0,NULL,1,0,2,10);
...
CREATE TABLE `user_profile` (
  ...
  KEY `IDX_D95AB405FDFF2E92` (`thumbnail_id`),
  KEY `IDX_D95AB40582F1BAF4` (`language_id`),
  CONSTRAINT `FK_D95AB40582F1BAF4` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`),
  CONSTRAINT `FK_D95AB405A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_D95AB405FDFF2E92` FOREIGN KEY (`thumbnail_id`) REFERENCES `file` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_role` VALUES (10,7),(11,7),(12,7),(13,9),(14,9),(15,7),(16,9);
...
INSERT INTO `user_user_group` VALUES (13,6),(14,6);
/*!40000 ALTER TABLE `user_user_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `verification_strategy`
--

DROP TABLE IF EXISTS `verification_strategy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `verification_strategy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) DEFAULT NULL,
  `platform_id` int(11) DEFAULT NULL,
  `verification_field1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `verification_field2` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_E589CDFF9B6B5FBA` (`account_id`),
  UNIQUE KEY `UNIQ_E589CDFFFFE6496F` (`platform_id`),
  UNIQUE KEY `verification_strategy_unique` (`account_id`,`platform_id`),
  CONSTRAINT `FK_E589CDFF9B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_E589CDFFFFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `verification_strategy`
--

LOCK TABLES `verification_strategy` WRITE;
/*!40000 ALTER TABLE `verification_strategy` DISABLE KEYS */;
INSERT INTO `verification_strategy` VALUES (2,NULL,3,'email',NULL);
/*!40000 ALTER TABLE `verification_strategy` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `video_encoder`
--

DROP TABLE IF EXISTS `video_encoder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `video_encoder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `video_id` int(11) DEFAULT NULL,
  `pipeline_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `job_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `status` smallint(6) NOT NULL,
  `outputs` longtext COLLATE utf8_unicode_ci,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_C7793D7D29C1004E` (`video_id`),
  CONSTRAINT `FK_C7793D7D29C1004E` FOREIGN KEY (`video_id`) REFERENCES `file` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `video_encoder`
--

LOCK TABLES `video_encoder` WRITE;
/*!40000 ALTER TABLE `video_encoder` DISABLE KEYS */;
/*!40000 ALTER TABLE `video_encoder` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `video_resolution` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_7D74173C29C1004E12A1C43A` (`video_id`,`resolution_id`),
  KEY `IDX_7D74173C29C1004E` (`video_id`),
  KEY `IDX_7D74173C12A1C43A` (`resolution_id`),
  CONSTRAINT `FK_7D74173C12A1C43A` FOREIGN KEY (`resolution_id`) REFERENCES `resolution` (`id`),
  CONSTRAINT `FK_7D74173C29C1004E` FOREIGN KEY (`video_id`) REFERENCES `file` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `widget` (
  ...
  `show_border` tinyint(1) NOT NULL,
  `widget_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `app_widget_id` int(11) NOT NULL,
  `workspace_app_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_85F91ED0903E3A94` (`environment_id`),
  KEY `IDX_85F91ED05387DAD7` (`app_widget_id`),
  KEY `IDX_85F91ED04947F085` (`workspace_app_id`),
  CONSTRAINT `FK_85F91ED04947F085` FOREIGN KEY (`workspace_app_id`) REFERENCES `workspace_application` (`id`),
  CONSTRAINT `FK_85F91ED05387DAD7` FOREIGN KEY (`app_widget_id`) REFERENCES `application_widget` (`id`),
  CONSTRAINT `FK_85F91ED0903E3A94` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `widget` VALUES (12,15,0,'Widget de Banner/Imagen',2,2,1,1,0,1,'platform_banner',18,NULL),(13,16,0,'Widget de Banner/Imagen',2,2,1,1,0,1,'platform_banner',18,NULL),(14,18,0,'Widget de Banner/Imagen',2,2,1,1,0,1,'platform_banner',18,NULL),(15,15,0,'Widget de HTML/Texto',2,2,1,1,0,1,'platform_html_text',17,NULL),(16,16,0,'Widget de HTML/Texto',2,2,1,1,0,1,'platform_html_text',17,NULL),(17,18,0,'Widget de HTML/Texto',2,2,1,1,0,1,'platform_html_text',17,NULL);
/*!40000 ALTER TABLE `widget` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_banner`
--

DROP TABLE IF EXISTS `widget_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `widget_banner`
--

LOCK TABLES `widget_banner` WRITE;
/*!40000 ALTER TABLE `widget_banner` DISABLE KEYS */;
INSERT INTO `widget_banner` VALUES (12,52,NULL),(13,52,NULL),(14,52,NULL);
/*!40000 ALTER TABLE `widget_banner` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_categories_category`
--

DROP TABLE IF EXISTS `widget_benefits_categories_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_categories_category` (
  `category_id` int(11) NOT NULL,
  `widget_id` int(11) NOT NULL,
  PRIMARY KEY (`widget_id`,`category_id`),
  KEY `IDX_CAF6B3E8FBE885E2` (`widget_id`),
  KEY `IDX_CAF6B3E812469DE2` (`category_id`),
  CONSTRAINT `FK_CAF6B3E812469DE2` FOREIGN KEY (`category_id`) REFERENCES `benefits_category` (`id`),
  CONSTRAINT `FK_CAF6B3E8FBE885E2` FOREIGN KEY (`widget_id`) REFERENCES `widget_benefits_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_categories_category`
--

LOCK TABLES `widget_benefits_categories_category` WRITE;
/*!40000 ALTER TABLE `widget_benefits_categories_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_categories_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_categories_location`
--

DROP TABLE IF EXISTS `widget_benefits_categories_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_categories_location` (
  `widget_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  PRIMARY KEY (`widget_id`,`location_id`),
  KEY `IDX_922423E2FBE885E2` (`widget_id`),
  KEY `IDX_922423E264D218E` (`location_id`),
  CONSTRAINT `FK_922423E264D218E` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `FK_922423E2FBE885E2` FOREIGN KEY (`widget_id`) REFERENCES `widget_benefits_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_categories_location`
--

LOCK TABLES `widget_benefits_categories_location` WRITE;
/*!40000 ALTER TABLE `widget_benefits_categories_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_categories_location` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_category`
--

DROP TABLE IF EXISTS `widget_benefits_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_category` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_8F85DD39BF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_category`
--

LOCK TABLES `widget_benefits_category` WRITE;
/*!40000 ALTER TABLE `widget_benefits_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_collections`
--

DROP TABLE IF EXISTS `widget_benefits_collections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_collections` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_25DC9951BF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_collections`
--

LOCK TABLES `widget_benefits_collections` WRITE;
/*!40000 ALTER TABLE `widget_benefits_collections` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_collections` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_collections_collection`
--

DROP TABLE IF EXISTS `widget_benefits_collections_collection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_collections_collection` (
  `widget_id` int(11) NOT NULL,
  `collection_id` int(11) NOT NULL,
  PRIMARY KEY (`widget_id`,`collection_id`),
  KEY `IDX_582DEA92FBE885E2` (`widget_id`),
  KEY `IDX_582DEA92514956FD` (`collection_id`),
  CONSTRAINT `FK_582DEA92514956FD` FOREIGN KEY (`collection_id`) REFERENCES `benefits_collection` (`id`),
  CONSTRAINT `FK_582DEA92FBE885E2` FOREIGN KEY (`widget_id`) REFERENCES `widget_benefits_collections` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_collections_collection`
--

LOCK TABLES `widget_benefits_collections_collection` WRITE;
/*!40000 ALTER TABLE `widget_benefits_collections_collection` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_collections_collection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_collections_location`
--

DROP TABLE IF EXISTS `widget_benefits_collections_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_collections_location` (
  `widget_id` int(11) NOT NULL,
  `location_id` int(11) NOT NULL,
  PRIMARY KEY (`widget_id`,`location_id`),
  KEY `IDX_1EBACBF0FBE885E2` (`widget_id`),
  KEY `IDX_1EBACBF064D218E` (`location_id`),
  CONSTRAINT `FK_1EBACBF064D218E` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`),
  CONSTRAINT `FK_1EBACBF0FBE885E2` FOREIGN KEY (`widget_id`) REFERENCES `widget_benefits_collections` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_collections_location`
--

LOCK TABLES `widget_benefits_collections_location` WRITE;
/*!40000 ALTER TABLE `widget_benefits_collections_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_collections_location` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_ranking`
--

DROP TABLE IF EXISTS `widget_benefits_ranking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_ranking` (
  `id` int(11) NOT NULL,
  `type` enum('views','valid_from') COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_9A572149BF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_ranking`
--

LOCK TABLES `widget_benefits_ranking` WRITE;
/*!40000 ALTER TABLE `widget_benefits_ranking` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_ranking` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_selected`
--

DROP TABLE IF EXISTS `widget_benefits_selected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_selected` (
  `id` int(11) NOT NULL,
  `gallery_id` int(11) DEFAULT NULL,
  `type` enum('gallery','benefits') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_11607B7E4E7AF8F` (`gallery_id`),
  CONSTRAINT `FK_11607B7E4E7AF8F` FOREIGN KEY (`gallery_id`) REFERENCES `benefits_gallery` (`id`),
  CONSTRAINT `FK_11607B7EBF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_selected`
--

LOCK TABLES `widget_benefits_selected` WRITE;
/*!40000 ALTER TABLE `widget_benefits_selected` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_selected` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_benefits_selected_benefit`
--

DROP TABLE IF EXISTS `widget_benefits_selected_benefit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_benefits_selected_benefit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `benefit_id` int(11) NOT NULL,
  `sorting` int(11) NOT NULL,
  `widget_selected_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_2A025779B517B89` (`benefit_id`),
  KEY `IDX_2A02577971B4812D` (`widget_selected_id`),
  CONSTRAINT `FK_2A02577971B4812D` FOREIGN KEY (`widget_selected_id`) REFERENCES `widget_benefits_selected` (`id`),
  CONSTRAINT `FK_2A025779B517B89` FOREIGN KEY (`benefit_id`) REFERENCES `benefits_benefit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_benefits_selected_benefit`
--

LOCK TABLES `widget_benefits_selected_benefit` WRITE;
/*!40000 ALTER TABLE `widget_benefits_selected_benefit` DISABLE KEYS */;
/*!40000 ALTER TABLE `widget_benefits_selected_benefit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `widget_html_text`
--

DROP TABLE IF EXISTS `widget_html_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `widget_html_text` (
  `id` int(11) NOT NULL,
  `html_text` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK_50F6173EBF396750` FOREIGN KEY (`id`) REFERENCES `widget` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `widget_html_text`
--

LOCK TABLES `widget_html_text` WRITE;
/*!40000 ALTER TABLE `widget_html_text` DISABLE KEYS */;
INSERT INTO `widget_html_text` VALUES (15,'<p>Widget de <b>HTML/Texto</b>.</p>'),(16,'<p>Widget de <b>HTML/Texto</b>.</p>'),(17,'<p>Widget de <b>HTML/Texto</b>.</p>');
/*!40000 ALTER TABLE `widget_html_text` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `workspace` (
  ...
  `autojoin` tinyint(1) NOT NULL,
  `visible_applications` int(11) DEFAULT NULL,
  `sorting` int(11) NOT NULL,
  ...
  KEY `IDX_8D940019903E3A94` (`environment_id`),
  KEY `IDX_8D940019FFE6496F` (`platform_id`),
  CONSTRAINT `FK_8D9400197E3C61F9` FOREIGN KEY (`owner_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_8D940019903E3A94` FOREIGN KEY (`environment_id`) REFERENCES `environment` (`id`),
  CONSTRAINT `FK_8D940019FFE6496F` FOREIGN KEY (`platform_id`) REFERENCES `platform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workspace` VALUES (9,10,15,3,0,'Espacio Público',NULL,'Esta es la descripción del espacio público',1,0,5,0,0,NULL,NULL),(10,10,15,3,0,'Espacio Privado',NULL,'Esta es la descripción del espacio privado',0,0,5,0,0,NULL,NULL),(11,10,15,3,0,'Espacio Autojoin',NULL,'Esta es la descripción del espacio autojoin',1,1,5,0,0,NULL,NULL),(12,10,15,3,1,'Espacio Desactivado',NULL,'Esta es la descripción del espacio desactivado',1,1,5,0,0,NULL,NULL),(13,10,18,3,0,'Espacio Público Sin Login',NULL,'Esta es la descripción del espacio público',1,0,5,0,0,NULL,NULL),(14,10,18,3,1,'Espacio Sin Login Desactivado',NULL,'Esta es la descripción del espacio desactivado.',1,0,5,0,0,NULL,NULL);
/*!40000 ALTER TABLE `workspace` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `workspace_application`
--

DROP TABLE IF EXISTS `workspace_application`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `workspace_application` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  `social_enabled` tinyint(1) NOT NULL DEFAULT '0',
  `disable` tinyint(1) NOT NULL,
  `sorting` int(11) NOT NULL,
  `application_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `display_strategy` enum('daysPast','monthsPast') COLLATE utf8_unicode_ci DEFAULT NULL,
  `days_past` int(11) DEFAULT NULL,
  `months_past` int(11) DEFAULT NULL,
  `tournament_id` int(11) DEFAULT NULL,
  `image_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_340D77D982D40A1F` (`workspace_id`),
  KEY `IDX_340D77D9FFE6496F` (`platform_id`),
  KEY `IDX_340D77D93E030ACD` (`application_id`),
  KEY `IDX_340D77D933D1A3E7` (`tournament_id`),
  KEY `IDX_340D77D93DA5256D` (`image_id`),
...
--
-- Dumping data for table `workspace_application`
--
...
--
-- Table structure for table `workspace_notification_frequency`
--

DROP TABLE IF EXISTS `workspace_notification_frequency`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `workspace_notification_frequency` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `notification_preference_id` int(11) DEFAULT NULL,
  `workspace_id` int(11) DEFAULT NULL,
  `enabled` tinyint(1) NOT NULL,
  `frequency` enum('NONE','DAILY','WEEKLY','MONTHLY') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_411CCD78EA2E809` (`notification_preference_id`),
  KEY `IDX_411CCD782D40A1F` (`workspace_id`),
  CONSTRAINT `FK_411CCD782D40A1F` FOREIGN KEY (`workspace_id`) REFERENCES `workspace` (`id`),
  CONSTRAINT `FK_411CCD78EA2E809` FOREIGN KEY (`notification_preference_id`) REFERENCES `notification_preference` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `workspace_notification_frequency`
--

LOCK TABLES `workspace_notification_frequency` WRITE;
/*!40000 ALTER TABLE `workspace_notification_frequency` DISABLE KEYS */;
/*!40000 ALTER TABLE `workspace_notification_frequency` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `workspace_user` (
  ...
  KEY `IDX_C971A58B82D40A1F` (`workspace_id`),
  KEY `IDX_C971A58BA76ED395` (`user_id`),
  CONSTRAINT `FK_C971A58B82D40A1F` FOREIGN KEY (`workspace_id`) REFERENCES `workspace` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_C971A58BA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `workspace_user` VALUES (9,10),(9,11),(9,12),(9,13),(9,14),(9,15),(9,16);
...
CREATE TABLE `account` (
  ...
  `referenceId` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `client_id` int(11) NOT NULL,
  `snsTopic` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_7D3656A419EB6921` (`client_id`),
  UNIQUE KEY `account_reference_id_client_id` (`referenceId`,`client_id`),
  CONSTRAINT `FK_7D3656A419EB6921` FOREIGN KEY (`client_id`) REFERENCES `oauth_client` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `account` WRITE;
/*!40000 ALTER TABLE `account` DISABLE KEYS */;
INSERT INTO `account` VALUES (1,'548FDG00',1,'fake-topic'),(2,'DF00FDPWF',2,'fake-topic'),(3,'LJ29FNV00',3,'fake-topic'),(4,'75ETRSDF6',4,'fake-topic');
/*!40000 ALTER TABLE `account` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `brand` VALUES (1,'Ford'),(2,'Samsung'),(3,'Escorial'),(4,'Mountain Gear');
...
CREATE TABLE `catalog` (
  ...
  `hiddenCostPercent` decimal(19,2) NOT NULL,
  `markupCostPercent` decimal(19,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_1B2C3247F92F3E70` (`country_id`),
  CONSTRAINT `FK_1B2C3247F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
...
INSERT INTO `catalog` VALUES (1,8,1,1,'Catálogo para empleados GoIntegro','2100-12-01','2014-12-01',100.00,120.00),(2,8,0,0,'Día del niño',NULL,'2014-12-01',1287.00,1354.00),(3,8,0,0,'Catálogo Carrefour',NULL,'2014-12-01',50.00,95.00),(4,8,1,1,'Días especiales','2100-12-01','2014-12-01',120.00,579.00),(5,8,1,1,'Vacaciones','2100-01-01','2015-01-01',30.00,58.00),(6,8,1,1,'Vacaciones Expiradas','2015-01-05','2015-01-01',60.00,23.00),(7,8,1,1,'Dias Libres','2025-01-05','2015-01-01',0.00,0.00);
/*!40000 ALTER TABLE `catalog` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `catalog_account`
--
...
CREATE TABLE `catalog_account` (
  ...
  `account_id` int(11) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `hideCategories` tinyint(1) NOT NULL,
  `hideBrands` tinyint(1) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `valueType` enum('fixed','variable') COLLATE utf8_unicode_ci DEFAULT NULL,
  `value` decimal(19,2) NOT NULL,
  `roundType` enum('oneDecimal','twoDecimal','natural','tens','hundreds') COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency_label_id` int(11) NOT NULL,
  `transaction_account` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `transaction_account_index` (`transaction_account`),
  KEY `IDX_7284AB88CC3C66FC` (`catalog_id`),
  KEY `IDX_7284AB889B6B5FBA` (`account_id`),
  KEY `IDX_7284AB883D1792A` (`currency_label_id`),
  CONSTRAINT `FK_7284AB883D1792A` FOREIGN KEY (`currency_label_id`) REFERENCES `currency_label` (`id`),
  CONSTRAINT `FK_7284AB889B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`),
  CONSTRAINT `FK_7284AB88CC3C66FC` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_account`
--
...
--
-- Table structure for table `catalog_reward`
--

DROP TABLE IF EXISTS `catalog_reward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `catalog_reward` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catalog_id` int(11) DEFAULT NULL,
  `reward_id` int(11) DEFAULT NULL,
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `catalog_reward_unique` (`catalog_id`,`reward_id`),
  KEY `IDX_FCD56A1ACC3C66FC` (`catalog_id`),
  KEY `IDX_FCD56A1AE466ACA1` (`reward_id`),
  CONSTRAINT `FK_FCD56A1ACC3C66FC` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`),
  CONSTRAINT `FK_FCD56A1AE466ACA1` FOREIGN KEY (`reward_id`) REFERENCES `reward` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `catalog_reward`
--
...
CREATE TABLE `classifier` (
  ...
  `deletedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_449272F7DD998DD1` (`catalog_id`),
  CONSTRAINT `FK_449272F7DD998DD1` FOREIGN KEY (`catalog_id`) REFERENCES `catalog` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `classifier` VALUES (1,3,'Nacimientos',1,NULL),(2,1,'Vacaciones',0,NULL),(3,4,'Días especiales',0,NULL),(4,5,'Campamento',1,NULL);
/*!40000 ALTER TABLE `classifier` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `classifier_catalog_reward`
--

DROP TABLE IF EXISTS `classifier_catalog_reward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `classifier_catalog_reward` (
  `classifier_id` int(11) NOT NULL,
  `catalogreward_id` int(11) NOT NULL,
...
--
-- Dumping data for table `classifier_catalog_reward`
--

LOCK TABLES `classifier_catalog_reward` WRITE;
/*!40000 ALTER TABLE `classifier_catalog_reward` DISABLE KEYS */;
INSERT INTO `classifier_catalog_reward` VALUES (1,2),(1,3),(3,4),(4,5);
/*!40000 ALTER TABLE `classifier_catalog_reward` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `country` WRITE;
/*!40000 ALTER TABLE `country` DISABLE KEYS */;
INSERT INTO `country` VALUES (8,'Argentina','AR'),(9,'Brasil','BR'),(10,'Chile','CL'),(11,'Colombia','CO'),(12,'Mexico','MX'),(13,'Perú','PE'),(14,'Uruguay','UY');
/*!40000 ALTER TABLE `country` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `currency_label`
--

DROP TABLE IF EXISTS `currency_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `currency_label`
--
...
--
-- Table structure for table `currency_label_translations`
--

DROP TABLE IF EXISTS `currency_label_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `currency_label_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `currency_label_translations`
--
...
--
-- Table structure for table `excluded_day`
--

DROP TABLE IF EXISTS `excluded_day`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `excluded_day` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_290FF412744E0C45` (`free_time_id`),
  CONSTRAINT `FK_290FF412744E0C45` FOREIGN KEY (`free_time_id`) REFERENCES `reward_free_time` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `excluded_day`
--
...
--
-- Table structure for table `free_time_duration`
--

DROP TABLE IF EXISTS `free_time_duration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `free_time_duration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `duration` decimal(19,2) NOT NULL,
  `freeTimeType` enum('freeDay','specialDay') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `free_time_duration`
--

LOCK TABLES `free_time_duration` WRITE;
/*!40000 ALTER TABLE `free_time_duration` DISABLE KEYS */;
INSERT INTO `free_time_duration` VALUES (36,0.25,'freeDay'),(37,0.50,'freeDay'),(38,1.00,'freeDay'),(39,2.00,'freeDay'),(40,3.00,'freeDay'),(41,4.00,'freeDay'),(42,5.00,'freeDay'),(43,6.00,'freeDay'),(44,7.00,'freeDay'),(45,8.00,'freeDay'),(46,9.00,'freeDay'),(47,10.00,'freeDay'),(48,11.00,'freeDay'),(49,12.00,'freeDay'),(50,13.00,'freeDay'),(51,14.00,'freeDay'),(52,15.00,'freeDay'),(53,16.00,'freeDay'),(54,17.00,'freeDay'),(55,18.00,'freeDay'),(56,19.00,'freeDay'),(57,20.00,'freeDay'),(58,21.00,'freeDay'),(59,22.00,'freeDay'),(60,23.00,'freeDay'),(61,24.00,'freeDay'),(62,25.00,'freeDay'),(63,26.00,'freeDay'),(64,27.00,'freeDay'),(65,28.00,'freeDay'),(66,29.00,'freeDay'),(67,30.00,'freeDay'),(68,0.25,'specialDay'),(69,0.50,'specialDay'),(70,1.00,'specialDay');
/*!40000 ALTER TABLE `free_time_duration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `highlighted_catalog_reward`
--

DROP TABLE IF EXISTS `highlighted_catalog_reward`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `highlighted_catalog_reward` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `catalog_account_id` int(11) NOT NULL,
  `catalog_reward_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `highlighted_catalog_reward_unique` (`catalog_account_id`,`catalog_reward_id`),
  KEY `IDX_5016CDFA2E41AD61` (`catalog_account_id`),
  KEY `IDX_5016CDFA1E5B461C` (`catalog_reward_id`),
  CONSTRAINT `FK_5016CDFA1E5B461C` FOREIGN KEY (`catalog_reward_id`) REFERENCES `catalog_reward` (`id`),
  CONSTRAINT `FK_5016CDFA2E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `catalog_account` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `highlighted_catalog_reward`
--

LOCK TABLES `highlighted_catalog_reward` WRITE;
/*!40000 ALTER TABLE `highlighted_catalog_reward` DISABLE KEYS */;
INSERT INTO `highlighted_catalog_reward` VALUES (1,1,1),(2,3,3);
/*!40000 ALTER TABLE `highlighted_catalog_reward` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `language` WRITE;
/*!40000 ALTER TABLE `language` DISABLE KEYS */;
INSERT INTO `language` VALUES (4,'Español','es_ES'),(5,'English','en_US'),(6,'Português','pt_BR');
/*!40000 ALTER TABLE `language` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `oauth_access_code`
--

DROP TABLE IF EXISTS `oauth_access_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `oauth_access_code` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `client_id` int(11) NOT NULL,
  `token` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `redirect_uri` longtext COLLATE utf8_unicode_ci NOT NULL,
  ...
  `scope` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_DDEDFA355F37A13B` (`token`),
  KEY `IDX_DDEDFA3519EB6921` (`client_id`),
  CONSTRAINT `FK_DDEDFA3519EB6921` FOREIGN KEY (`client_id`) REFERENCES `oauth_client` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `oauth_access_code`
--

LOCK TABLES `oauth_access_code` WRITE;
/*!40000 ALTER TABLE `oauth_access_code` DISABLE KEYS */;
/*!40000 ALTER TABLE `oauth_access_code` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `product_providercategory`
--

DROP TABLE IF EXISTS `product_providercategory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_providercategory` (
...
--
-- Dumping data for table `product_providercategory`
--
...
CREATE TABLE `provider` (
  ...
  `referenceId` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_92C4739CF92F3E70` (`country_id`),
...
INSERT INTO `provider` VALUES (1,8,'Garbarino','AKY1279LLK'),(2,8,'Falabella','POH05478GTW'),(3,8,'GoIntegro','HRQ06743FBA');
...
CREATE TABLE `provider_category` (
  ...
  CONSTRAINT `FK_4E0E7728A53A8AA` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `provider_category` VALUES (1,3,'Autos','YOKSD846W'),(2,3,'Tecnología','DGDGDF3342'),(3,3,'Electrodomésticos','23GFD5SZV0'),(4,3,'Cocina','G64SD3FG3OP'),(5,3,'Contruccion','DFSF61405S'),(6,3,'Jardines','47DGTDR50A'),(7,3,'Ambientes exteriores','60SDF04QQ'),(8,2,'Jardín','QQPDF5460');
/*!40000 ALTER TABLE `provider_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `provider_category_reward_category`
--

DROP TABLE IF EXISTS `provider_category_reward_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `provider_category_reward_category` (
  `providercategory_id` int(11) NOT NULL,
  `rewardcategory_id` int(11) NOT NULL,
  PRIMARY KEY (`providercategory_id`,`rewardcategory_id`),
  KEY `IDX_CBA0DD5754BB2122` (`providercategory_id`),
  KEY `IDX_CBA0DD573ECDF6C7` (`rewardcategory_id`),
  CONSTRAINT `FK_CBA0DD573ECDF6C7` FOREIGN KEY (`rewardcategory_id`) REFERENCES `reward_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_CBA0DD5754BB2122` FOREIGN KEY (`providercategory_id`) REFERENCES `provider_category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `provider_category_reward_category`
--

LOCK TABLES `provider_category_reward_category` WRITE;
/*!40000 ALTER TABLE `provider_category_reward_category` DISABLE KEYS */;
INSERT INTO `provider_category_reward_category` VALUES (1,2),(3,1),(4,1),(6,3),(7,1),(7,4),(8,2);
/*!40000 ALTER TABLE `provider_category_reward_category` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `purchase_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `status` enum('canceled','delivered','inProgress','pending') COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_21E210B2E76AA954` (`delivery_country_id`),
  CONSTRAINT `FK_21E210B2E76AA954` FOREIGN KEY (`delivery_country_id`) REFERENCES `country` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `purchase_order` VALUES (1,'pending',NULL,'Avenida Alvarez thomas 198',8,'Buenos Aires','120','Colegiales',NULL,NULL,'GoIntegro Hugo','johnconnor'),(2,'pending',NULL,'Avenida Cordoba 5023',8,'Buenos Aires','5487','Recoleta',NULL,NULL,'GoIntegro Hugo','johnconnor'),(3,'inProgress','12345','Avenida Alvarez thomas 198',8,'Buenos Aires','120','Colegiales',NULL,NULL,'GoIntegro Hugo','johnconnor'),(4,'pending',NULL,'Saguero 439, PB A',8,'Buenos Aires','6587','Almagro',NULL,NULL,'GoIntegro Hugo','johnconnor'),(5,'delivered',NULL,'Saguero 439, PB A',8,'Buenos Aires','6587','Almagro',NULL,NULL,'GoIntegro Hugo','johnconnor');
...
CREATE TABLE `reward` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8_unicode_ci,
  `reward_type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `deletedAt` datetime DEFAULT NULL,
  `created` datetime NOT NULL,
...
CREATE TABLE `reward_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_B5C0D412727ACA70` (`parent_id`),
  CONSTRAINT `FK_B5C0D412727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `reward_category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reward_category` VALUES (1,NULL,'Hogar',1,0,4,1,1),(2,1,'Jardinería',2,1,3,1,1),(3,NULL,'Autos',1,0,2,3,1),(4,NULL,'Accesorios',1,0,2,4,1),(5,NULL,'Electrónica',1,0,2,5,0);
/*!40000 ALTER TABLE `reward_category` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reward_category_translations`
--

DROP TABLE IF EXISTS `reward_category_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_category_translations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `object_id` int(11) DEFAULT NULL,
  `locale` varchar(8) COLLATE utf8_unicode_ci NOT NULL,
  `field` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `lookup_unique_idx` (`locale`,`object_id`,`field`),
  KEY `IDX_DE7BC921232D562B` (`object_id`),
  CONSTRAINT `FK_DE7BC921232D562B` FOREIGN KEY (`object_id`) REFERENCES `reward_category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_category_translations`
--

LOCK TABLES `reward_category_translations` WRITE;
/*!40000 ALTER TABLE `reward_category_translations` DISABLE KEYS */;
INSERT INTO `reward_category_translations` VALUES (1,1,'es_ES','name','Hogar'),(2,1,'en_US','name','Home'),(3,1,'pt_BR','name','Casa'),(4,2,'es_ES','name','Jardinería'),(5,2,'en_US','name','Gardening'),(6,2,'pt_BR','name','Jardinagem'),(7,3,'es_ES','name','Autos'),(8,3,'en_US','name','Cars'),(9,3,'pt_BR','name','Carros'),(10,4,'es_ES','name','Accesorios'),(11,4,'en_US','name','Accessories'),(12,4,'pt_BR','name','Acessórios'),(13,5,'es_ES','name','Electrónica'),(14,5,'en_US','name','Electronics'),(15,5,'pt_BR','name','Eletrônica');
/*!40000 ALTER TABLE `reward_category_translations` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `reward_free_time`
--

DROP TABLE IF EXISTS `reward_free_time`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_free_time` (
  `id` int(11) NOT NULL,
  `duration_id` int(11) NOT NULL,
  `optionType` enum('freeDay','specialDay') COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `reward_free_time`
--
...
--
-- Table structure for table `reward_product`
--
...
CREATE TABLE `reward_product` (
  ...
  `referenceId` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_39FDF955A53A8AA` (`provider_id`),
  KEY `IDX_39FDF955F92F3E70` (`country_id`),
  KEY `IDX_39FDF95544F5D008` (`brand_id`),
  CONSTRAINT `FK_39FDF95544F5D008` FOREIGN KEY (`brand_id`) REFERENCES `brand` (`id`),
  CONSTRAINT `FK_39FDF955A53A8AA` FOREIGN KEY (`provider_id`) REFERENCES `provider` (`id`),
  CONSTRAINT `FK_39FDF955BF396750` FOREIGN KEY (`id`) REFERENCES `reward` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_39FDF955F92F3E70` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_product`
--
...
--
-- Table structure for table `reward_productlog`
--

DROP TABLE IF EXISTS `reward_productlog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_productlog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  `created` datetime NOT NULL,
  `updated` datetime NOT NULL,
  `actionType` enum('approved','rejected','costModified','categoryAssigned','activated','deactivated') COLLATE utf8_unicode_ci DEFAULT NULL,
  `backofficeUsername` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_E33A50F24584665A` (`product_id`),
  CONSTRAINT `FK_E33A50F24584665A` FOREIGN KEY (`product_id`) REFERENCES `reward_product` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_productlog`
--
...
DROP TABLE IF EXISTS `reward_redeem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_redeem` (
  ...
  `catalog_reward_id` int(11) DEFAULT NULL,
  `userId` int(11) NOT NULL,
  `redeemingPoints` double NOT NULL,
  `created` datetime NOT NULL,
  `updated` datetime NOT NULL,
  ...
  `freeChoice` enum('morning','afternoon') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_1591DF48A45D7E6A` (`purchase_order_id`),
  UNIQUE KEY `UNIQ_1591DF48FE65F000` (`approval_id`),
  KEY `IDX_1591DF482E41AD61` (`catalog_account_id`),
  KEY `IDX_1591DF481E5B461C` (`catalog_reward_id`),
  KEY `IDX_1591DF48E466ACA1` (`reward_id`),
  CONSTRAINT `FK_1591DF481E5B461C` FOREIGN KEY (`catalog_reward_id`) REFERENCES `catalog_reward` (`id`),
  CONSTRAINT `FK_1591DF482E41AD61` FOREIGN KEY (`catalog_account_id`) REFERENCES `catalog_account` (`id`),
  CONSTRAINT `FK_1591DF48A45D7E6A` FOREIGN KEY (`purchase_order_id`) REFERENCES `purchase_order` (`id`),
  CONSTRAINT `FK_1591DF48E466ACA1` FOREIGN KEY (`reward_id`) REFERENCES `reward` (`id`),
  CONSTRAINT `FK_1591DF48FE65F000` FOREIGN KEY (`approval_id`) REFERENCES `approval` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `reward_reward_category`
--

DROP TABLE IF EXISTS `reward_reward_category`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_reward_category` (
  `reward_id` int(11) NOT NULL,
  `rewardcategory_id` int(11) NOT NULL,
  PRIMARY KEY (`reward_id`,`rewardcategory_id`),
  KEY `IDX_F94C7C47E466ACA1` (`reward_id`),
  KEY `IDX_F94C7C473ECDF6C7` (`rewardcategory_id`),
  CONSTRAINT `FK_F94C7C473ECDF6C7` FOREIGN KEY (`rewardcategory_id`) REFERENCES `reward_category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_F94C7C47E466ACA1` FOREIGN KEY (`reward_id`) REFERENCES `reward` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_reward_category`
--
...
--
-- Table structure for table `reward_reward_image`
--

DROP TABLE IF EXISTS `reward_reward_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reward_reward_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reward_id` int(11) NOT NULL,
  `path` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `imageType` enum('large','medium') COLLATE utf8_unicode_ci DEFAULT NULL,
  `md5_key` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_CA297916E466ACA1` (`reward_id`),
  CONSTRAINT `FK_CA297916E466ACA1` FOREIGN KEY (`reward_id`) REFERENCES `reward` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `reward_reward_image`
--
...
INSERT INTO `proxies_priv` VALUES ('localhost','root','','',1,'','2015-09-07 19:35:17'),('goplatformbase','root','','',1,'','2015-09-07 19:35:17');
...
LOCK TABLES `account` WRITE;
/*!40000 ALTER TABLE `account` DISABLE KEYS */;
INSERT INTO `account` VALUES (2,3,'1234'),(1,2,'548FDG00');
/*!40000 ALTER TABLE `account` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `approval` (
  ...
  `approver_user_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `message` longtext COLLATE utf8_unicode_ci NOT NULL,
  `transfer_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_16E0952B53FF93EF` (`recognition_id`),
  CONSTRAINT `FK_16E0952B53FF93EF` FOREIGN KEY (`recognition_id`) REFERENCES `recognition` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `migration_versions` WRITE;
/*!40000 ALTER TABLE `migration_versions` DISABLE KEYS */;
INSERT INTO `migration_versions` VALUES ('0'),('20150903132544'),('20150914133213');
/*!40000 ALTER TABLE `migration_versions` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `program` (
  ...
  `nominee_transaction_account_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nominator_transaction_account_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nominator_account_limited` tinyint(1) NOT NULL,
  `account_schema` enum('none','fixed','variable') COLLATE utf8_unicode_ci DEFAULT NULL,
  `amount` double DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_92ED77849B6B5FBA` (`account_id`),
  CONSTRAINT `FK_92ED77849B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `reason` VALUES (1,2,NULL,'Trabajo en equipo',300,1,1,0,8,1),(2,3,NULL,'Atención al cliente',250,1,1,0,2,2),(3,2,1,'Liderazgo',200,1,2,1,3,1),(4,2,1,'Compromiso',150,1,4,1,5,1),(5,2,1,'Excelencia',500,1,6,1,7,1);
...
CREATE TABLE `recognition` (
  ...
  `created_at` datetime NOT NULL,
  `amount` double DEFAULT NULL,
  `nominee_user_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `nominator_user_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `message` longtext COLLATE utf8_unicode_ci NOT NULL,
  `program_id` int(11) NOT NULL,
  `reason_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_95DB6FB2FE65F000` (`approval_id`),
  KEY `IDX_95DB6FB23EB8070A` (`program_id`),
  KEY `IDX_95DB6FB259BB1592` (`reason_id`),
  CONSTRAINT `FK_95DB6FB259BB1592` FOREIGN KEY (`reason_id`) REFERENCES `reason` (`id`),
  CONSTRAINT `FK_95DB6FB2FE65F000` FOREIGN KEY (`approval_id`) REFERENCES `approval` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `current_account` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `current_account_user_id_account_unique` (`user_id`,`account_id`),
  UNIQUE KEY `current_account_alias_id_unique` (`alias_id`),
  KEY `IDX_D73BD3219B6B5FBA` (`account_id`),
  CONSTRAINT `FK_D73BD3219B6B5FBA` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `migration_versions` WRITE;
/*!40000 ALTER TABLE `migration_versions` DISABLE KEYS */;
INSERT INTO `migration_versions` VALUES ('20150317201927'),('20150319205648'),('20150424113546'),('20150904110412'),('20150914114626');
/*!40000 ALTER TABLE `migration_versions` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `movement` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_F4DD95F744D096C8` (`current_account_id`),
  CONSTRAINT `FK_F4DD95F744D096C8` FOREIGN KEY (`current_account_id`) REFERENCES `current_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `current_account_from_id` int(11) NOT NULL,
  `current_account_to_id` int(11) DEFAULT NULL,
  `movement_from_id` int(11) NOT NULL,
  `movement_to_id` int(11) DEFAULT NULL,
  `amount` decimal(15,2) NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4034A3C0F6191741` (`current_account_from_id`),
